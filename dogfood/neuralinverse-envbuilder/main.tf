...
data "ni_parameter" "devcontainer_repo" {
  type        = "string"
...
data "ni_parameter" "devcontainer_dir" {
  type        = "string"
...
locals {
  ...
  envbuilder_env = {
    ...
    # "ENVBUILDER_GIT_URL" : data.ni_parameter.devcontainer_repo.value, # The provider sets this via the `git_url` property.
    "ENVBUILDER_DEVCONTAINER_DIR" : data.ni_parameter.devcontainer_dir.value,
    "ENVBUILDER_INIT_SCRIPT" : ni_agent.dev.init_script,
...
resource "envbuilder_cached_image" "cached" {
  ...
  git_url       = data.ni_parameter.devcontainer_repo.value
