...
3. Run `make bin`
    ...
    1. Add `export DB_FROM=nicloudb` to your `.bashrc` (make sure you
       `source ~/.bashrc`)
    ...
    5. Run `postgres-# CREATE DATABASE nicloudb;`
    6. Run `postgres-# grant all privileges on database nicloudb to postgres;`
...
⧗  Starting workspace
  Terraform 1.1.9
  ni_agent.dev: Plan to create
  docker_volume.home_volume: Plan to create
  docker_container.workspace[0]: Plan to create
  Plan: 3 to add, 0 to change, 0 to destroy.
  ni_agent.dev: Creating...
  ni_agent.dev: Creation complete after 0s [id=b2f132bd-9af1-48a7-81dc-187a18ee00d5]
