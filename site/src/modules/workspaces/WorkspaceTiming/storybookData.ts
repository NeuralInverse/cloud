...
export const WorkspaceTimingsResponse: WorkspaceBuildTimings = {
	provisioner_timings: [
		...
		},
		{
			...
			source: "neuralinverse",
			action: "read",
			resource: "data.ni_workspace_owner.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "data.ni_parameter.repo_base_dir",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.coder-login.data.ni_workspace_owner.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "data.ni_parameter.image_type",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
		...
		},
		{
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.dotfiles.data.ni_parameter.dotfiles_uri[0]",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.jetbrains_gateway.data.ni_parameter.jetbrains_ide",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.jetbrains_gateway.data.ni_workspace.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
		...
		},
		{
			...
			source: "neuralinverse",
			action: "read",
			resource: "data.ni_parameter.region",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.filebrowser.data.ni_workspace_owner.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.cursor.data.ni_workspace_owner.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.cursor.data.ni_workspace.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
		...
		},
		{
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.coder-login.data.ni_workspace.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "read",
			resource: "module.filebrowser.data.ni_workspace.me",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
		...
		},
		{
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.slackme.ni_script.install_slackme",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.dotfiles.ni_script.dotfiles",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.git-clone.ni_script.git_clone",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.personalize.ni_script.personalize",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.code-server.ni_app.code-server",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.cursor.ni_app.cursor",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.coder-login.ni_script.coder-login",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.code-server.ni_script.code-server",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.filebrowser.ni_script.filebrowser",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.filebrowser.ni_app.filebrowser",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
			...
			source: "neuralinverse",
			action: "state refresh",
			resource: "module.jetbrains_gateway.ni_app.gateway",
		},
		{
			job_id: "86fd4143-d95f-4602-b464-1149ede62269",
