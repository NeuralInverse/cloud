...
func TestUsernameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Username, func(t *testing.T) {
			t.Parallel()
			valid := nicloudsdk.NameValid(testCase.Username)
...
func TestTemplateDisplayNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			valid := nicloudsdk.DisplayNameValid(testCase.Name)
			require.Equal(t, testCase.Valid, valid == nil)
		})
	}
}
...
func TestTemplateVersionNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			valid := nicloudsdk.TemplateVersionNameValid(testCase.Name)
			require.Equal(t, testCase.Valid, valid == nil)
		})
	}
}
...
func TestGeneratedTemplateVersionNameValid(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		err := nicloudsdk.TemplateVersionNameValid(name)
...
func TestFrom(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.From, func(t *testing.T) {
			t.Parallel()
			converted := nicloudsdk.UsernameFrom(testCase.From)
			t.Log(converted)
			valid := nicloudsdk.NameValid(converted)
...
func TestUserRealNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			err := nicloudsdk.UserRealNameValid(testCase.Name)
			norm := nicloudsdk.NormalizeRealUsername(testCase.Name)
			normErr := nicloudsdk.UserRealNameValid(norm)
...
func TestGroupNameValid(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.Name, func(t *testing.T) {
			t.Parallel()
			err := nicloudsdk.GroupNameValid(testCase.Name)
			assert.Equal(
				t,
				testCase.Valid,
				err == nil,
