...
type Workspace struct {
	...
	// TaskID, if set, indicates that the workspace is relevant to the given nicloudsdk.Task.
...
type UpdateWorkspaceACL struct {
	...
	// (available as a constant named nicloudsdk.WorkspaceRoleDeleted)
...
// ExternalAgentCredentials contains the credentials needed for an external agent to connect to Neural Inverse Cloud.
