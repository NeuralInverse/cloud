...
`
		...
		require.Equal(t, req.Email, "alice@cloud.neuralinverse.com")
		...
		require.Equal(t, req.UserLoginType, nicloudsdk.LoginTypeNone)
	})
...
func TestCreateUserRequestJSON(t *testing.T) {
	...
	marshalTest := func(t *testing.T, req nicloudsdk.CreateUserRequestWithOrgs) {
		t.Helper()
		data, err := json.Marshal(req)
		require.NoError(t, err)
		var req2 nicloudsdk.CreateUserRequestWithOrgs
