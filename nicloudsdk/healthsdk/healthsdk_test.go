...
func TestSummarize(t *testing.T) {
	...
	t.Run("HealthcheckReport", func(t *testing.T) {
		...
		expected := []string{
			...
			"See: https://cloud.neuralinverse.com/docs/admin/monitoring/health-check#test",
	...
	for _, tt := range []struct {
		...
		},
		{
			...
			expected: []string{
				...
				"See: https://cloud.neuralinverse.com/docs/admin/monitoring/health-check#test01",
				"Warn: TEST02: testing two",
				"See: https://cloud.neuralinverse.com/docs/admin/monitoring/health-check#test02",
			},
		},
		{
			name: "prefix",
