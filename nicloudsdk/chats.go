...
// nicloud/database asserts this alignment at CI time.
...
// Keep these in sync with nicloud/exp_chats.go.
const (
...
func NewDynamicTool[T any](
	...
	if err != nil {
		panic(fmt.Sprintf("nicloudsdk: failed to marshal schema for %q: %v", name, err))
	}
