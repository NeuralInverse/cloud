...
type BuildUpdate struct {
	Transition nicloudsdk.WorkspaceTransition  `json:"transition"`
	JobStatus  nicloudsdk.ProvisionerJobStatus `json:"job_status"`
}

type AgentUpdate struct {
	Lifecycle nicloudsdk.WorkspaceAgentLifecycle `json:"lifecycle"`
