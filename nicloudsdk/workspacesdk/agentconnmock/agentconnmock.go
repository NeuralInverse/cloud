...
import (
	...
	healthsdk "github.com/NeuralInverse/cloud/v2/nicloudsdk/healthsdk"
	workspacesdk "github.com/NeuralInverse/cloud/v2/nicloudsdk/workspacesdk"
	wsjson "github.com/NeuralInverse/cloud/v2/nicloudsdk/wsjson"
	tailnet "github.com/NeuralInverse/cloud/v2/tailnet"
)
...
func (m *MockAgentConn) ListContainers(ctx context.Context) (nicloudsdk.WorkspaceAgentListContainersResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockAgentConn) ListeningPorts(ctx context.Context) (nicloudsdk.WorkspaceAgentListeningPortsResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListeningPorts", ctx)
	ret0, _ := ret[0].(nicloudsdk.WorkspaceAgentListeningPortsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAgentConn) RecreateDevcontainer(ctx context.Context, devcontainerID string) (nicloudsdk.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecreateDevcontainer", ctx, devcontainerID)
	ret0, _ := ret[0].(nicloudsdk.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAgentConn) WatchContainers(ctx context.Context, logger slog.Logger) (<-chan nicloudsdk.WorkspaceAgentListContainersResponse, io.Closer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchContainers", ctx, logger)
	ret0, _ := ret[0].(<-chan nicloudsdk.WorkspaceAgentListContainersResponse)
...
func (m *MockAgentConn) WatchGit(ctx context.Context, logger slog.Logger, chatID uuid.UUID) (*wsjson.Stream[nicloudsdk.WorkspaceAgentGitServerMessage, nicloudsdk.WorkspaceAgentGitClientMessage], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchGit", ctx, logger, chatID)
	ret0, _ := ret[0].(*wsjson.Stream[nicloudsdk.WorkspaceAgentGitServerMessage, nicloudsdk.WorkspaceAgentGitClientMessage])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
