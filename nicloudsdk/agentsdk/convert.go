...
func MetadataDescriptionsFromProto(descriptions []*proto.WorkspaceAgentMetadata_Description) []nicloudsdk.WorkspaceAgentMetadataDescription {
	ret := make([]nicloudsdk.WorkspaceAgentMetadataDescription, len(descriptions))
...
func ProtoFromMetadataDescriptions(descriptions []nicloudsdk.WorkspaceAgentMetadataDescription) []*proto.WorkspaceAgentMetadata_Description {
...
func MetadataDescriptionFromProto(description *proto.WorkspaceAgentMetadata_Description) nicloudsdk.WorkspaceAgentMetadataDescription {
	return nicloudsdk.WorkspaceAgentMetadataDescription{
...
func ProtoFromMetadataDescription(d nicloudsdk.WorkspaceAgentMetadataDescription) *proto.WorkspaceAgentMetadata_Description {
...
func ProtoFromMetadataResult(r nicloudsdk.WorkspaceAgentMetadataResult) *proto.WorkspaceAgentMetadata_Result {
...
func MetadataResultFromProto(r *proto.WorkspaceAgentMetadata_Result) nicloudsdk.WorkspaceAgentMetadataResult {
	return nicloudsdk.WorkspaceAgentMetadataResult{
...
func AgentScriptsFromProto(protoScripts []*proto.WorkspaceAgentScript) ([]nicloudsdk.WorkspaceAgentScript, error) {
	ret := make([]nicloudsdk.WorkspaceAgentScript, len(protoScripts))
...
func ProtoFromScripts(scripts []nicloudsdk.WorkspaceAgentScript) []*proto.WorkspaceAgentScript {
...
func AgentScriptFromProto(protoScript *proto.WorkspaceAgentScript) (nicloudsdk.WorkspaceAgentScript, error) {
	id, err := uuid.FromBytes(protoScript.Id)
	if err != nil {
		return nicloudsdk.WorkspaceAgentScript{}, xerrors.Errorf("parse id: %w", err)
	}

	logSourceID, err := uuid.FromBytes(protoScript.LogSourceId)
	if err != nil {
		return nicloudsdk.WorkspaceAgentScript{}, xerrors.Errorf("parse log source id: %w", err)
	}
...
func ProtoFromScript(s nicloudsdk.WorkspaceAgentScript) *proto.WorkspaceAgentScript {
...
func AppsFromProto(protoApps []*proto.WorkspaceApp) ([]nicloudsdk.WorkspaceApp, error) {
	ret := make([]nicloudsdk.WorkspaceApp, len(protoApps))
...
func ProtoFromApps(apps []nicloudsdk.WorkspaceApp) ([]*proto.WorkspaceApp, error) {
...
func AppFromProto(protoApp *proto.WorkspaceApp) (nicloudsdk.WorkspaceApp, error) {
	id, err := uuid.FromBytes(protoApp.Id)
	if err != nil {
		return nicloudsdk.WorkspaceApp{}, xerrors.Errorf("parse id: %w", err)
	}

	sharingLevel := nicloudsdk.WorkspaceAppSharingLevel(strings.ToLower(protoApp.SharingLevel.String()))
	if _, ok := nicloudsdk.MapWorkspaceAppSharingLevels[sharingLevel]; !ok {
		return nicloudsdk.WorkspaceApp{}, xerrors.Errorf("unknown app sharing level: %v (%q)", protoApp.SharingLevel, protoApp.SharingLevel.String())
	}

	health := nicloudsdk.WorkspaceAppHealth(strings.ToLower(protoApp.Health.String()))
	if _, ok := nicloudsdk.MapWorkspaceAppHealths[health]; !ok {
		return nicloudsdk.WorkspaceApp{}, xerrors.Errorf("unknown app health: %v (%q)", protoApp.Health, protoApp.Health.String())
	}

	return nicloudsdk.WorkspaceApp{
		ID:            id,
		URL:           protoApp.Url,
...
func ProtoFromApp(a nicloudsdk.WorkspaceApp) (*proto.WorkspaceApp, error) {
...
func ServiceBannerFromProto(sbp *proto.ServiceBanner) nicloudsdk.BannerConfig {
	return nicloudsdk.BannerConfig{
...
func ProtoFromServiceBanner(sb nicloudsdk.BannerConfig) *proto.ServiceBanner {
...
func BannerConfigFromProto(sbp *proto.BannerConfig) nicloudsdk.BannerConfig {
	return nicloudsdk.BannerConfig{
		Enabled:         sbp.GetEnabled(),
		Message:         sbp.GetMessage(),
		BackgroundColor: sbp.GetBackgroundColor(),
...
func ProtoFromBannerConfig(sb nicloudsdk.BannerConfig) *proto.BannerConfig {
...
func ProtoFromSubsystems(ss []nicloudsdk.AgentSubsystem) ([]proto.Startup_Subsystem, error) {
...
func LifecycleStateFromProto(s proto.Lifecycle_State) (nicloudsdk.WorkspaceAgentLifecycle, error) {
	caps, ok := proto.Lifecycle_State_name[int32(s)]
	if !ok {
		return "", xerrors.Errorf("unknown lifecycle state: %d", s)
	}
	return nicloudsdk.WorkspaceAgentLifecycle(strings.ToLower(caps)), nil
}

func ProtoFromLifecycleState(s nicloudsdk.WorkspaceAgentLifecycle) (proto.Lifecycle_State, error) {
...
func DevcontainersFromProto(pdcs []*proto.WorkspaceAgentDevcontainer) ([]nicloudsdk.WorkspaceAgentDevcontainer, error) {
	ret := make([]nicloudsdk.WorkspaceAgentDevcontainer, len(pdcs))
...
func DevcontainerFromProto(pdc *proto.WorkspaceAgentDevcontainer) (nicloudsdk.WorkspaceAgentDevcontainer, error) {
	id, err := uuid.FromBytes(pdc.Id)
	if err != nil {
		return nicloudsdk.WorkspaceAgentDevcontainer{}, xerrors.Errorf("parse id: %w", err)
	}
	...
	if pdc.SubagentId != nil {
		...
		if err != nil {
			return nicloudsdk.WorkspaceAgentDevcontainer{}, xerrors.Errorf("parse subagent id: %w", err)
		}
	}
	return nicloudsdk.WorkspaceAgentDevcontainer{
		ID:              id,
		Name:            pdc.Name,
...
func ProtoFromDevcontainers(dcs []nicloudsdk.WorkspaceAgentDevcontainer) []*proto.WorkspaceAgentDevcontainer {
...
func ProtoFromDevcontainer(dc nicloudsdk.WorkspaceAgentDevcontainer) *proto.WorkspaceAgentDevcontainer {
	var subagentID []byte
