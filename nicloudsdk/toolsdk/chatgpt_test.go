...
func TestChatGPTSearch_WorkspaceSearch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var workspaceClient *nicloudsdk.Client
			if tt.setupOwner == "self" {
				workspaceOwnerID = owner.UserID
				workspaceClient = client
			} else {
				var workspaceOwner nicloudsdk.User
				workspaceClient, workspaceOwner = nicloudtest.CreateAnotherUserMutators(t, client, owner.OrganizationID, nil, func(r *nicloudsdk.CreateUserRequestWithOrgs) {
...
func TestChatGPTFetch_TemplateFetch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var templateData nicloudsdk.Template
...
func TestChatGPTFetch_WorkspaceFetch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Validate JSON marshaling
			var workspaceData nicloudsdk.Workspace
