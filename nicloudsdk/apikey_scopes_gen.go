...
const (
	// Deprecated: use nicloudsdk.APIKeyScopeNeural Inverse CloudAll instead.
	APIKeyScopeAll APIKeyScope = "all"
	// Deprecated: use nicloudsdk.APIKeyScopeNeural Inverse CloudApplicationConnect instead.
