...
func TestAIProviderSettings_Marshal(t *testing.T) {
	...
	t.Run("EmptyEmitsNull", func(t *testing.T) {
		t.Parallel()
		got, err := json.Marshal(nicloudsdk.AIProviderSettings{})
...
func TestAIProviderSettings_Unmarshal(t *testing.T) {
	...
	t.Run("ResetsBetweenCalls", func(t *testing.T) {
		...
		s := nicloudsdk.AIProviderSettings{
			Bedrock: &nicloudsdk.AIProviderBedrockSettings{Region: "us-east-1"},
		}
		require.NoError(t, json.Unmarshal([]byte(`null`), &s))
		require.True(t, s.IsZero())
...
func TestAIProviderSettings_Roundtrip(t *testing.T) {
	t.Parallel()
	orig := nicloudsdk.AIProviderSettings{
		Bedrock: &nicloudsdk.AIProviderBedrockSettings{
			Region:          "us-west-2",
	...
	var got nicloudsdk.AIProviderSettings
