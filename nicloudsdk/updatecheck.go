...
// UpdateCheckResponse contains information on the latest release of Neural Inverse Cloud.
type UpdateCheckResponse struct {
	// Current indicates whether the server version is the same as the latest.
	Current bool `json:"current"`
	// Version is the semantic version for the latest release of Neural Inverse Cloud.
	Version string `json:"version"`
	// URL to download the latest release of Neural Inverse Cloud.
	URL string `json:"url"`
}

// UpdateCheck returns information about the latest release version of
// Neural Inverse Cloud and whether or not the server is running the latest release.
