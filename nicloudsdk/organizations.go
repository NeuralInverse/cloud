...
// Organization is the JSON representation of a Neural Inverse Cloud organization.
...
type CreateTemplateRequest struct {
	...
	// FailureTTLMillis allows optionally specifying the max lifetime before Neural Inverse Cloud
	// stops all resources for failed workspaces created from this template.
	FailureTTLMillis *int64 `json:"failure_ttl_ms,omitempty"`
	// TimeTilDormantMillis allows optionally specifying the max lifetime before Neural Inverse Cloud
	// locks inactive workspaces created from this template.
	TimeTilDormantMillis *int64 `json:"dormant_ttl_ms,omitempty"`
	// TimeTilDormantAutoDeleteMillis allows optionally specifying the max lifetime before Neural Inverse Cloud
