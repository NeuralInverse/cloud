...
func TestDeploymentValues_HighlyConfigurable(t *testing.T) {
	...
	set := (&nicloudsdk.DeploymentValues{}).Options()
	for _, opt := range set {
		...
		if nicloudsdk.IsSecretDeploymentOption(opt) && opt.YAML != "" {
		...
		// Also check all env vars are prefixed with NEURALINVERSE_
		const prefix = "NEURALINVERSE_"
...
func TestTimezoneOffsets(t *testing.T) {
	...
	for _, c := range testCases {
		t.Run(c.Name, func(t *testing.T) {
			...
			offset := nicloudsdk.TimezoneOffsetHourWithTime(c.Now, c.Loc)
...
func TestAIGatewayCompatibilityAliases(t *testing.T) {
	...
	options := (&nicloudsdk.DeploymentValues{}).Options()
	...
	aiConfFromOpts := func(t *testing.T, apply func(opts serpent.OptionSet) error) nicloudsdk.AIConfig {
		t.Helper()
	...
	t.Run("YAMLParity", func(t *testing.T) {
		...
		parse := func(doc map[string]any) nicloudsdk.AIConfig {
			var node yaml.Node
...
func TestDeploymentValues_Validate_RefreshLifetime(t *testing.T) {
	...
	mk := func(access, refresh time.Duration) *nicloudsdk.DeploymentValues {
		dv := &nicloudsdk.DeploymentValues{}
...
func TestExternalAuthYAMLConfig(t *testing.T) {
	...
	githubCfg := nicloudsdk.ExternalAuthConfig{
		Type:                          "github",
		ClientID:                      "client_id",
	...
	expected := []nicloudsdk.ExternalAuthConfig{
		githubCfg, githubCfg,
	}
...
func TestFeatureComparison(t *testing.T) {
	...
	testCases := []struct {
		Name     string
		A        nicloudsdk.Feature
		B        nicloudsdk.Feature
		Expected int
	}{
		{
			Name:     "Empty",
		...
		//		Entitled
		{
			...
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementGracePeriod},
			Expected: 1,
		},
		{
			...
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementGracePeriod, Limit: ptr.Ref[int64](100), Actual: ptr.Ref[int64](50)},
			Expected: 1,
		},
		{
			Name:     "EntitledVsNotEntitled",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementNotEntitled},
			Expected: 3,
		},
		{
			Name:     "EntitledVsUnknown",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled},
			B:        nicloudsdk.Feature{Entitlement: ""},
			Expected: 4,
		},
		//		GracePeriod
		{
			Name:     "GracefulVsNotEntitled",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementGracePeriod},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementNotEntitled},
			Expected: 2,
		},
		{
		...
		//		NotEntitled
		{
			...
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementNotEntitled},
			B:        nicloudsdk.Feature{Entitlement: ""},
			Expected: 1,
		},
		// --
		{
			...
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref[int64](100), Actual: ptr.Ref[int64](200)},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementGracePeriod, Limit: ptr.Ref[int64](300), Actual: ptr.Ref[int64](200)},
			Expected: -1,
		},
		// UserLimits
		{
		...
		},
		{
			...
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(200))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementNotEntitled, Limit: ptr.Ref(int64(300)), Actual: ptr.Ref(int64(200))},
			Expected: 3,
		},
		{
			Name:     "HigherLimit",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(110)), Actual: ptr.Ref(int64(200))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(200))},
			Expected: 10, // Diff in the limit #
		},
		{
			Name:     "HigherActual",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(300))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(200))},
			Expected: 100, // Diff in the actual #
		},
		{
			Name:     "LimitExists",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(50))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: nil, Actual: ptr.Ref(int64(200))},
			Expected: 1,
		},
		{
			Name:     "LimitExistsGrace",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementGracePeriod, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(50))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementGracePeriod, Limit: nil, Actual: ptr.Ref(int64(200))},
			Expected: 1,
		},
		{
			Name:     "ActualExists",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(50))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: nil},
			Expected: 1,
		},
		{
			Name:     "NotNils",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(100)), Actual: ptr.Ref(int64(50))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: nil, Actual: nil},
			Expected: 1,
		},
		{
			Name:     "EnabledVsDisabled",
			A:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Enabled: true, Limit: ptr.Ref(int64(300)), Actual: ptr.Ref(int64(200))},
			B:        nicloudsdk.Feature{Entitlement: nicloudsdk.EntitlementEntitled, Limit: ptr.Ref(int64(300)), Actual: ptr.Ref(int64(200))},
			Expected: 1,
		},
		{
			Name:     "NotNils",
...
func TestPremiumSuperSet(t *testing.T) {
	...
	enterprise := nicloudsdk.FeatureSetEnterprise
	premium := nicloudsdk.FeatureSetPremium
	...
	expectedPremiumFeatures := []nicloudsdk.FeatureName{}
...
func TestNotificationsCanBeDisabled(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			environment: []serpent.EnvVar{
				{
					Name:  "NEURALINVERSE_EMAIL_SMARTHOST",
					Value: "localhost:587",
				},
			},
		...
		},
		{
			...
			environment: []serpent.EnvVar{
				{
					Name:  "NEURALINVERSE_NOTIFICATIONS_WEBHOOK_ENDPOINT",
...
func TestRetentionConfigParsing(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			environment: []serpent.EnvVar{
				{Name: "NEURALINVERSE_AUDIT_LOGS_RETENTION", Value: "30d"},
				{Name: "NEURALINVERSE_CONNECTION_LOGS_RETENTION", Value: "60d"},
				{Name: "NEURALINVERSE_API_KEYS_RETENTION", Value: "14d"},
			},
		...
		},
		{
			...
			environment: []serpent.EnvVar{
				{Name: "NEURALINVERSE_AUDIT_LOGS_RETENTION", Value: "365d"},
				{Name: "NEURALINVERSE_CONNECTION_LOGS_RETENTION", Value: "30d"},
				{Name: "NEURALINVERSE_API_KEYS_RETENTION", Value: "0"},
			},
...
func TestAIBudgetConfigParsing(t *testing.T) {
	...
	t.Run("Defaults", func(t *testing.T) {
		...
		assert.Equal(t, string(nicloudsdk.AIBudgetPolicyHighest), dv.AI.BridgeConfig.BudgetPolicy)
		assert.Equal(t, string(nicloudsdk.AIBudgetPeriodMonth), dv.AI.BridgeConfig.BudgetPeriod)
	})
	...
	t.Run("AcceptsSupportedValues", func(t *testing.T) {
		...
		require.NoError(t, opts.ParseEnv([]serpent.EnvVar{
			{Name: "NEURALINVERSE_AI_BUDGET_POLICY", Value: string(nicloudsdk.AIBudgetPolicyHighest)},
			{Name: "NEURALINVERSE_AI_BUDGET_PERIOD", Value: string(nicloudsdk.AIBudgetPeriodMonth)},
		}))
	...
	t.Run("RejectsUnsupportedPolicy", func(t *testing.T) {
		...
		err := opts.ParseEnv([]serpent.EnvVar{
			{Name: "NEURALINVERSE_AI_BUDGET_POLICY", Value: "invalid"},
		})
		require.Error(t, err)
	...
	t.Run("RejectsUnsupportedPeriod", func(t *testing.T) {
		...
		require.NoError(t, opts.SetDefaults())
		err := opts.ParseEnv([]serpent.EnvVar{
			{Name: "NEURALINVERSE_AI_BUDGET_PERIOD", Value: "invalid"},
		})
		require.Error(t, err)
		assert.Contains(t, err.Error(), "invalid choice")
	})
...
func TestComputeMaxIdleConns(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := nicloudsdk.ComputeMaxIdleConns(tt.maxOpen, tt.configuredIdle)
			if tt.expectError {
				require.Error(t, err)
...
func TestHTTPCookieConfigMiddleware(t *testing.T) {
	...
	cases := []struct {
		name            string
		cfg             nicloudsdk.HTTPCookieConfig
	...
	}{
		{
			...
			cfg:  nicloudsdk.HTTPCookieConfig{},
			extraCookies: []*http.Cookie{
				{Name: nicloudsdk.SessionTokenCookie, Value: "token123"},
			},
			expectedCookies: map[string]string{
				nicloudsdk.SessionTokenCookie: "token123",
			},
		},
		{
			name: "Enabled_StripsPrefixFromCookie",
			cfg:  nicloudsdk.HTTPCookieConfig{EnableHostPrefix: true},
			extraCookies: []*http.Cookie{
				{Name: "__Host-" + nicloudsdk.SessionTokenCookie, Value: "token123"},
			},
			expectedCookies: map[string]string{
				nicloudsdk.SessionTokenCookie: "token123",
			},
		},
		{
			...
			extraCookies: []*http.Cookie{
				...
				{Name: nicloudsdk.SessionTokenCookie, Value: "unprefixed-token"},
			},
			expectedCookies: map[string]string{
				// Session token should NOT be present - it was deleted.
			},
			expectedDeleted: []string{nicloudsdk.SessionTokenCookie},
		},
		{
			...
			extraCookies: []*http.Cookie{
				...
				{Name: nicloudsdk.SessionTokenCookie, Value: "unprefixed-token"},
				{Name: "__Host-" + nicloudsdk.SessionTokenCookie, Value: "prefixed-token"},
			},
			expectedCookies: map[string]string{
				nicloudsdk.SessionTokenCookie: "prefixed-token", // Prefixed wins.
			},
			expectedDeleted: []string{nicloudsdk.SessionTokenCookie},
		},
		{
			...
			cfg:  nicloudsdk.HTTPCookieConfig{EnableHostPrefix: true},
			extraCookies: []*http.Cookie{
				{Name: "__Host-" + nicloudsdk.SessionTokenCookie, Value: "session"},
				{Name: "__Host-SomeOtherCookie", Value: "other-cookie"},
				{Name: "__Host-Santa", Value: "santa"},
			},
			expectedCookies: map[string]string{
				nicloudsdk.SessionTokenCookie: "session",
...
func BenchmarkHTTPCookieConfigMiddleware(b *testing.B) {
	...
	cases := []struct {
	...
	}{
		{
			...
			cfg:  nicloudsdk.HTTPCookieConfig{},
			extraCookies: []*http.Cookie{
				{Name: nicloudsdk.SessionTokenCookie, Value: "KybJV9fNul-u11vlll9wiF6eLQDxBVucD"},
			},
		},
		{
		...
		},
		{
			...
			cfg:  nicloudsdk.HTTPCookieConfig{EnableHostPrefix: true},
			extraCookies: []*http.Cookie{
				{Name: "__Host-" + nicloudsdk.SessionTokenCookie, Value: "KybJV9fNul-u11vlll9wiF6eLQDxBVucD"},
			},
		},
		{
			name: "Enabled_MultiplePrefixedCookies",
			...
			extraCookies: []*http.Cookie{
				{Name: "__Host-" + nicloudsdk.SessionTokenCookie, Value: "KybJV9fNul-u11vlll9wiF6eLQDxBVucD"},
				{Name: "__Host-" + nicloudsdk.PathAppSessionTokenCookie, Value: "xyz123"},
				{Name: "__Host-" + nicloudsdk.SubdomainAppSessionTokenCookie, Value: "abc456"},
				{Name: "__Host-" + "foobar", Value: "do-not-change-me"},
			},
		},
		{
