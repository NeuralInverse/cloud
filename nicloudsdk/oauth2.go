...
// Neural Inverse Cloud as an OAuth2 provider.
...
// PostOAuth2ProviderApp adds an application that can authenticate using Neural Inverse Cloud
...
// PutOAuth2ProviderApp updates an application that can authenticate using Neural Inverse Cloud
// as an OAuth2 provider.
