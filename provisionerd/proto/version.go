...
//     back to Neural Inverse Cloudd. Used for uploading module files in support of dynamic
//     parameters.
...
//   - Added new field named `id` to `App`, which transports the ID generated by the ni_app provider to be persisted.
...
//
// API v1.13:
//   - Removed experimental fields `exp_reuse_terraform_workspace`. Caching moved into Neural Inverse Cloudd
//
// API v1.14:
//   - Added new field `template_version_modules_file` to Metadata
//   - Added `FailedFile` type for file upload failures.
//   - Add `DownloadFile` capability for provisioner daemons to fetch files from nicloud.
...
//     secret values from nicloud to provisioner daemons.
