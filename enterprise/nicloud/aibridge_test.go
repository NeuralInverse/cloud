...
import (
	...
	aiblib "github.com/NeuralInverse/cloud/v2/aibridge"
...
func TestAIBridgeListInterceptions(t *testing.T) {
	...
	t.Run("RequiresLicenseFeature", func(t *testing.T) {
		...
		_, err := client.AIBridgeListInterceptions(ctx, nicloudsdk.AIBridgeListInterceptionsFilter{})
	...
	t.Run("EmptyDB", func(t *testing.T) {
		t.Parallel()
		client, _ := nicloudenttest.New(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)
		//nolint:gocritic // Owner role is irrelevant here.
		res, err := client.AIBridgeListInterceptions(ctx, nicloudsdk.AIBridgeListInterceptionsFilter{})
	...
	t.Run("OK", func(t *testing.T) {
		t.Parallel()
		client, db, firstUser := nicloudenttest.NewWithDatabase(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)

		user1, err := client.User(ctx, nicloudsdk.Me)
		require.NoError(t, err)
		...
		_, user2 := nicloudtest.CreateAnotherUser(t, client, firstUser.OrganizationID)
		...
		require.Equal(t, []nicloudsdk.AIBridgeInterception{i2SDK, i1SDK}, res.Results)
	})
	...
	t.Run("Authorized", func(t *testing.T) {
		t.Parallel()
		adminClient, db, firstUser := nicloudenttest.NewWithDatabase(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)

		secondUserClient, secondUser := nicloudtest.CreateAnotherUser(t, adminClient, firstUser.OrganizationID)
		...
		res, err := secondUserClient.AIBridgeListInterceptions(ctx, nicloudsdk.AIBridgeListInterceptionsFilter{})
		require.NoError(t, err)
		...
		res, err = adminClient.AIBridgeListInterceptions(ctx, nicloudsdk.AIBridgeListInterceptionsFilter{})
		require.NoError(t, err)
	...
	t.Run("Filter", func(t *testing.T) {
		...
		cases := []struct {
			name   string
			filter nicloudsdk.AIBridgeListInterceptionsFilter
			want   []nicloudsdk.AIBridgeInterception
		}{
			{
				name:   "NoFilter",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{},
				want:   []nicloudsdk.AIBridgeInterception{i1SDK, i2SDK, i3SDK},
			},
			{
				name:   "Initiator/NoMatch",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Initiator: uuid.New().String()},
				want:   []nicloudsdk.AIBridgeInterception{},
			},
			{
				name:   "Initiator/Me",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Initiator: nicloudsdk.Me},
				want:   []nicloudsdk.AIBridgeInterception{i1SDK, i2SDK},
			},
			{
				name:   "Initiator/UserID",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Initiator: user2.ID.String()},
				want:   []nicloudsdk.AIBridgeInterception{i3SDK},
			},
			{
				name:   "Initiator/Username",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Initiator: user2.Username},
				want:   []nicloudsdk.AIBridgeInterception{i3SDK},
			},
			{
				name:   "Provider/NoMatch",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Provider: "nonsense"},
				want:   []nicloudsdk.AIBridgeInterception{},
			},
			{
				name:   "Provider/OK",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Provider: "two"},
				want:   []nicloudsdk.AIBridgeInterception{i2SDK},
			},
			{
				name:   "Model/NoMatch",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Model: "nonsense"},
				want:   []nicloudsdk.AIBridgeInterception{},
			},
			{
				name:   "Model/OK",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Model: "three"},
				want:   []nicloudsdk.AIBridgeInterception{i3SDK},
			},
			{
				name:   "Client/Unknown",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Client: string(aiblib.ClientUnknown)},
				want:   []nicloudsdk.AIBridgeInterception{i1SDK},
			},
			{
				name:   "Client/Match",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Client: string(aiblib.ClientCursor)},
				want:   []nicloudsdk.AIBridgeInterception{i2SDK},
			},
			{
				name:   "Client/NoMatch",
				filter: nicloudsdk.AIBridgeListInterceptionsFilter{Client: "nonsense"},
				want:   []nicloudsdk.AIBridgeInterception{},
			},
			{
	...
	t.Run("FilterByMe/MemberCannotReadOwn", func(t *testing.T) {
		...
		ownerClient, db, firstUser := nicloudenttest.NewWithDatabase(t, &nicloudenttest.Options{
			Options: &nicloudtest.Options{
				DeploymentValues: dv,
			},
			LicenseOptions: &nicloudenttest.LicenseOptions{
		...
		memberClient, member := nicloudtest.CreateAnotherUser(t, ownerClient, firstUser.OrganizationID)
		...
		// filtering by "me".
		res, err := memberClient.AIBridgeListInterceptions(ctx, nicloudsdk.AIBridgeListInterceptionsFilter{
	...
	t.Run("FilterErrors", func(t *testing.T) {
		...
		cases := []struct {
			name string
			q    string
			want []nicloudsdk.ValidationError
		}{
			{
...
func aibridgeOpts(t *testing.T) *nicloudenttest.Options {
	t.Helper()
	dv := nicloudtest.DeploymentValues(t)
	dv.AI.BridgeConfig.Enabled = serpent.Bool(true)
	return &nicloudenttest.Options{
		Options: &nicloudtest.Options{
			DeploymentValues: dv,
		},
		LicenseOptions: &nicloudenttest.LicenseOptions{
...
func TestAIBridgeListSessions(t *testing.T) {
	...
	t.Run("EmptyDB", func(t *testing.T) {
		...
		ctx := testutil.Context(t, testutil.WaitLong)
		//nolint:gocritic // Owner role is irrelevant here.
		res, err := client.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{})
		require.NoError(t, err)
	...
	t.Run("Pagination", func(t *testing.T) {
		...
		res, err = client.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{
			Pagination: nicloudsdk.Pagination{Limit: 2, Offset: 2},
		})
		require.NoError(t, err)
		require.Len(t, res.Sessions, 2)
		...
		_, err = client.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{
			Pagination:     nicloudsdk.Pagination{Limit: 2, Offset: 1},
	...
	t.Run("AfterSessionIDNotFound", func(t *testing.T) {
		...
		//nolint:gocritic // Owner role is irrelevant here.
		_, err := client.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{
			Pagination:     nicloudsdk.Pagination{Limit: 10},
	...
	t.Run("FilterByMe/MemberCannotReadOwn", func(t *testing.T) {
		t.Parallel()
		ownerClient, db, firstUser := nicloudenttest.NewWithDatabase(t, aibridgeOpts(t))
		ctx := testutil.Context(t, testutil.WaitLong)
		...
		// filtering by "me".
		res, err := memberClient.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{
			Initiator: nicloudsdk.Me,
		})
		require.NoError(t, err)
		require.EqualValues(t, 0, res.Count)
	...
	t.Run("Authorized", func(t *testing.T) {
		...
		auditorClient, auditorUser := nicloudtest.CreateAnotherUser(t, adminClient, firstUser.OrganizationID, rbac.RoleAuditor())
		...
		res, err := auditorClient.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{})
		require.NoError(t, err)
		require.EqualValues(t, 2, res.Count)
		require.Len(t, res.Sessions, 2)
	...
	t.Run("CursorPaginationWithTiedStartedAt", func(t *testing.T) {
		...
		all, err := client.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{})
		require.NoError(t, err)
		...
		page, err := client.AIBridgeListSessions(ctx, nicloudsdk.AIBridgeListSessionsFilter{
			Pagination:     nicloudsdk.Pagination{Limit: 10},
...
func TestAIBridgeListClients(t *testing.T) {
	...
	dv := nicloudtest.DeploymentValues(t)
	dv.AI.BridgeConfig.Enabled = serpent.Bool(true)
	client, db, firstUser := nicloudenttest.NewWithDatabase(t, &nicloudenttest.Options{
		Options: &nicloudtest.Options{
			DeploymentValues: dv,
		},
		LicenseOptions: &nicloudenttest.LicenseOptions{
...
func TestAIBridgeGetSessionThreads(t *testing.T) {
	...
	t.Run("NotFound", func(t *testing.T) {
		t.Parallel()
		ownerClient, firstUser := nicloudenttest.New(t, aibridgeOpts(t))
...
func TestAIBridgeAllowBYOK(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			allowBYOK: true,
			reqHeaders: map[string]string{
				agplaibridge.HeaderNIToken: "coder-token",
...
func TestGroupAIBudget(t *testing.T) {
	...
	t.Run("Upsert", func(t *testing.T) {
		...
		newBudget, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, nicloudsdk.UpsertGroupAIBudgetRequest{
		...
		updatedBudget, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, nicloudsdk.UpsertGroupAIBudgetRequest{
	...
	t.Run("DeleteWhenPresent", func(t *testing.T) {
		...
		_, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, nicloudsdk.UpsertGroupAIBudgetRequest{
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
	...
	t.Run("AcceptsZeroSpendLimitToBlock", func(t *testing.T) {
		...
		budget, err := adminClient.UpsertGroupAIBudget(ctx, group.ID, nicloudsdk.UpsertGroupAIBudgetRequest{
			SpendLimitMicros: 0,
		})
		require.NoError(t, err)
	...
	t.Run("GroupMemberCanReadButNotWrite", func(t *testing.T) {
		...
		ownerClient, owner := nicloudenttest.New(t, &nicloudenttest.Options{
			Options: &nicloudtest.Options{DeploymentValues: dv},
			LicenseOptions: &nicloudenttest.LicenseOptions{
				Features: license.Features{
		...
		adminClient, _ := nicloudtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.RoleUserAdmin())
		memberClient, member := nicloudtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)

		ctx := testutil.Context(t, testutil.WaitLong)
		group, err := adminClient.CreateGroup(ctx, owner.OrganizationID, nicloudsdk.CreateGroupRequest{
			Name: "budget-group",
		})
		require.NoError(t, err)

		// Add the member to the group so the Group.RBACObject ACL grants them read.
		_, err = adminClient.PatchGroup(ctx, group.ID, nicloudsdk.PatchGroupRequest{
		...
		_, err = memberClient.UpsertGroupAIBudget(ctx, group.ID, nicloudsdk.UpsertGroupAIBudgetRequest{
			SpendLimitMicros: 1_000_000_000,
		})
		var sdkErr *nicloudsdk.Error
		require.ErrorAs(t, err, &sdkErr)
...
func TestUserAIBudgetOverride(t *testing.T) {
	...
	t.Run("Upsert/CreatesAndUpdates", func(t *testing.T) {
		...
		newOverride, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, nicloudsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          group.ID,
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
		...
		updatedOverride, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, nicloudsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          group.ID,
			SpendLimitMicros: 1_000_000_000,
		})
		require.NoError(t, err)
	...
	t.Run("Upsert/ReassignsGroup", func(t *testing.T) {
		...
		_, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, nicloudsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          groupA.ID,
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
		...
		groupB, err := adminClient.CreateGroup(ctx, targetUser.OrganizationIDs[0], nicloudsdk.CreateGroupRequest{
			Name: "reassign-test-group-b",
		})
		require.NoError(t, err)
		_, err = adminClient.PatchGroup(ctx, groupB.ID, nicloudsdk.PatchGroupRequest{
			AddUsers: []string{targetUser.ID.String()},
		})
		require.NoError(t, err)

		// Reassign the override's attribution to groupB.
		updated, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, nicloudsdk.UpsertUserAIBudgetOverrideRequest{
			GroupID:          groupB.ID,
			SpendLimitMicros: 500_000_000,
		})
		require.NoError(t, err)
	...
	t.Run("Upsert/EveryoneGroup", func(t *testing.T) {
		...
		override, err := adminClient.UpsertUserAIBudgetOverride(ctx, targetUser.ID, nicloudsdk.UpsertUserAIBudgetOverrideRequest{
	...
	t.Run("Upsert/RejectsNonMemberGroup", func(t *testing.T) {
		...
		outsiderGroup, err := adminClient.CreateGroup(ctx, targetUser.OrganizationIDs[0], nicloudsdk.CreateGroupRequest{
			Name: "outsider-group",
		})
		require.NoError(t, err)
...
func TestUserAIBudgetOverrideRoleAccess(t *testing.T) {
	...
	userAdminClient, _ := nicloudtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.RoleUserAdmin())
	...
	orgUserAdminClient, _ := nicloudtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID, rbac.ScopedRoleOrgUserAdmin(owner.OrganizationID))

	setupCtx := testutil.Context(t, testutil.WaitLong)
	group, err := userAdminClient.CreateGroup(setupCtx, owner.OrganizationID, nicloudsdk.CreateGroupRequest{
	...
	for _, tc := range cases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			_, targetUser := nicloudtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
			_, err := userAdminClient.PatchGroup(ctx, group.ID, nicloudsdk.PatchGroupRequest{
				AddUsers: []string{targetUser.ID.String()},
			})
			require.NoError(t, err)

			upsertReq := nicloudsdk.UpsertUserAIBudgetOverrideRequest{
				GroupID:          group.ID,
				SpendLimitMicros: 500_000_000,
			}
...
func setupUserAIBudgetOverrideTest(t *testing.T) (adminClient *nicloudsdk.Client, targetUser nicloudsdk.User, group nicloudsdk.Group) {
	t.Helper()
	...
	ctx := testutil.Context(t, testutil.WaitLong)
	g, err := adminClient.CreateGroup(ctx, owner.OrganizationID, nicloudsdk.CreateGroupRequest{
		Name: "override-test-group",
	})
	require.NoError(t, err)
	g, err = adminClient.PatchGroup(ctx, g.ID, nicloudsdk.PatchGroupRequest{
		AddUsers: []string{targetUser.ID.String()},
	})
	require.NoError(t, err)
...
func setupGroupAIBudgetTest(t *testing.T) (adminClient *nicloudsdk.Client, group nicloudsdk.Group) {
	t.Helper()
