...
// @Success 200 {object} nicloudsdk.GroupSyncSettings
...
// @Tags Enterprise
// @Param organization path string true "Organization ID" format(uuid)
// @Param request body nicloudsdk.GroupSyncSettings true "New settings"
// @Success 200 {object} nicloudsdk.GroupSyncSettings
...
func (api *API) patchGroupIDPSyncSettings(rw http.ResponseWriter, r *http.Request) {
	...
	aReq.New = *settings
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.GroupSyncSettings{
...
// @Param request body nicloudsdk.PatchGroupIDPSyncConfigRequest true "New config values"
...
func (api *API) patchGroupIDPSyncConfig(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PatchGroupIDPSyncConfigRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Success 200 {object} nicloudsdk.GroupSyncSettings
// @Param organization path string true "Organization ID or name" format(uuid)
// @Param request body nicloudsdk.PatchGroupIDPSyncMappingRequest true "Description of the mappings to add and remove"
...
func (api *API) patchGroupIDPSyncMapping(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PatchGroupIDPSyncMappingRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Tags Enterprise
// @Param organization path string true "Organization ID" format(uuid)
// @Success 200 {object} nicloudsdk.RoleSyncSettings
...
// @Tags Enterprise
// @Param organization path string true "Organization ID" format(uuid)
// @Param request body nicloudsdk.RoleSyncSettings true "New settings"
// @Success 200 {object} nicloudsdk.RoleSyncSettings
...
func (api *API) patchRoleIDPSyncSettings(rw http.ResponseWriter, r *http.Request) {
	...
	aReq.New = *settings
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.RoleSyncSettings{
		Field:   settings.Field,
		Mapping: settings.Mapping,
	})
}
...
// @Success 200 {object} nicloudsdk.RoleSyncSettings
// @Param organization path string true "Organization ID or name" format(uuid)
// @Param request body nicloudsdk.PatchRoleIDPSyncConfigRequest true "New config values"
...
func (api *API) patchRoleIDPSyncConfig(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PatchRoleIDPSyncConfigRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Success 200 {object} nicloudsdk.RoleSyncSettings
// @Param organization path string true "Organization ID or name" format(uuid)
// @Param request body nicloudsdk.PatchRoleIDPSyncMappingRequest true "Description of the mappings to add and remove"
...
func (api *API) patchRoleIDPSyncMapping(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PatchRoleIDPSyncMappingRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Produce json
// @Tags Enterprise
// @Success 200 {object} nicloudsdk.OrganizationSyncSettings
...
func (api *API) organizationIDPSyncSettings(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.OrganizationSyncSettings{
		Field:         settings.Field,
		Mapping:       settings.Mapping,
...
// @Tags Enterprise
// @Success 200 {object} nicloudsdk.OrganizationSyncSettings
// @Param request body nicloudsdk.OrganizationSyncSettings true "New settings"
...
// @Tags Enterprise
// @Success 200 {object} nicloudsdk.OrganizationSyncSettings
// @Param request body nicloudsdk.PatchOrganizationIDPSyncConfigRequest true "New config values"
...
func (api *API) patchOrganizationIDPSyncConfig(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PatchOrganizationIDPSyncConfigRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Tags Enterprise
// @Success 200 {object} nicloudsdk.OrganizationSyncSettings
// @Param request body nicloudsdk.PatchOrganizationIDPSyncMappingRequest true "Description of the mappings to add and remove"
...
func (api *API) patchOrganizationIDPSyncMapping(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PatchOrganizationIDPSyncMappingRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
func applyIDPSyncMappingDiff[IDType uuid.UUID | string](
	...
	add, remove []nicloudsdk.IDPSyncMapping[IDType],
) map[string][]IDType {
