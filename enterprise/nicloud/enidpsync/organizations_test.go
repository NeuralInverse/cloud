...
func TestOrganizationSync(t *testing.T) {
	...
	entitled.Modify(func(entitlements *nicloudsdk.Entitlements) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			db := dbauthz.New(rdb, rbac.NewAuthorizer(prometheus.NewRegistry()), logger, nicloudtest.AccessControlStorePointer())
