...
// @Success 200 {object} nicloudsdk.WorkspaceQuota
...
func (api *API) workspaceQuota(rw http.ResponseWriter, r *http.Request) {
	...
	licensed := api.Entitlements.Enabled(nicloudsdk.FeatureTemplateRBAC)
	...
	httpapi.Write(r.Context(), rw, http.StatusOK, nicloudsdk.WorkspaceQuota{
