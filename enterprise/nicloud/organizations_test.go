...
func TestMultiOrgFetch(t *testing.T) {
	...
	myOrgs, err := client.OrganizationsByUser(ctx, nicloudsdk.Me)
	require.NoError(t, err)
...
func TestOrganizationsByUser(t *testing.T) {
	...
	t.Run("IsDefault", func(t *testing.T) {
		...
		notDefault, err := client.CreateOrganization(ctx, nicloudsdk.CreateOrganizationRequest{
			Name:        "another",
			DisplayName: "Another",
		})
		require.NoError(t, err)
	...
	t.Run("NoMember", func(t *testing.T) {
		...
		other, _ := nicloudtest.CreateAnotherUser(t, client, first.OrganizationID)
		ctx := testutil.Context(t, testutil.WaitLong)
		...
		_, err = other.OrganizationByUserAndName(ctx, nicloudsdk.Me, org.Name)
...
func TestAddOrganizationMembers(t *testing.T) {
	...
	t.Run("OK", func(t *testing.T) {
		...
		_, user := nicloudtest.CreateAnotherUser(t, ownerClient, owner.OrganizationID)
...
func TestDeleteOrganizationsByUser(t *testing.T) {
	...
	t.Run("DeleteById", func(t *testing.T) {
		...
		o := nicloudenttest.CreateOrganization(t, client, nicloudenttest.CreateOrganizationOptions{})
...
func TestPatchOrganizationsByUser(t *testing.T) {
	...
	t.Run("Conflict", func(t *testing.T) {
		...
		_, err = client.UpdateOrganization(ctx, o.ID.String(), nicloudsdk.UpdateOrganizationRequest{
	...
	t.Run("ReservedName", func(t *testing.T) {
		...
		_, err = client.UpdateOrganization(ctx, o.ID.String(), nicloudsdk.UpdateOrganizationRequest{
			Name: nicloudsdk.DefaultOrganization,
		})
		var apiErr *nicloudsdk.Error
		require.ErrorAs(t, err, &apiErr)
		require.Equal(t, http.StatusBadRequest, apiErr.StatusCode())
	...
	t.Run("UpdateById", func(t *testing.T) {
		...
		o, err = client.UpdateOrganization(ctx, o.ID.String(), nicloudsdk.UpdateOrganizationRequest{
			Name: "new-new-org",
		})
		require.NoError(t, err)
	...
	t.Run("UpdateByName", func(t *testing.T) {
		...
		var err error
		o := nicloudenttest.CreateOrganization(t, client, nicloudenttest.CreateOrganizationOptions{}, func(request *nicloudsdk.CreateOrganizationRequest) {
			request.DisplayName = displayName
		})

		o, err = client.UpdateOrganization(ctx, o.Name, nicloudsdk.UpdateOrganizationRequest{
			Name: "new-new-org",
		})
		require.NoError(t, err)
		require.Equal(t, "new-new-org", o.Name)
...
func TestPostOrganizationsByUser(t *testing.T) {
	...
	t.Run("Create", func(t *testing.T) {
		...
		//nolint:gocritic // only owners can create orgs
		o, err := client.CreateOrganization(ctx, nicloudsdk.CreateOrganizationRequest{
			Name:        "new-org",
