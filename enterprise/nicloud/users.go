...
func (api *API) autostopRequirementEnabledMW(next http.Handler) http.Handler {
	return http.HandlerFunc(func(rw http.ResponseWriter, r *http.Request) {
		feature, ok := api.Entitlements.Feature(nicloudsdk.FeatureAdvancedTemplateScheduling)
...
// @Success 200 {array} nicloudsdk.UserQuietHoursScheduleResponse
...
func (api *API) userQuietHoursSchedule(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.UserQuietHoursScheduleResponse{
...
// @Tags Enterprise
// @Param user path string true "User ID" format(uuid)
// @Param request body nicloudsdk.UpdateUserQuietHoursScheduleRequest true "Update schedule request"
// @Success 200 {array} nicloudsdk.UserQuietHoursScheduleResponse
...
func (api *API) putUserQuietHoursSchedule(rw http.ResponseWriter, r *http.Request) {
	var (
		ctx               = r.Context()
		user              = httpmw.UserParam(r)
		params            nicloudsdk.UpdateUserQuietHoursScheduleRequest
