...
func createOpts(t *testing.T) *nicloudenttest.Options {
	t.Helper()
...
func TestUpdateNotificationTemplateMethod(t *testing.T) {
	...
	t.Run("Happy path", func(t *testing.T) {
		...
		api, _ := nicloudenttest.New(t, createOpts(t))
	...
	t.Run("Insufficient permissions", func(t *testing.T) {
		...
		api, firstUser := nicloudenttest.New(t, createOpts(t))
...
func getTemplateByID(t *testing.T, ctx context.Context, api *nicloudsdk.Client, id uuid.UUID) (*nicloudsdk.NotificationTemplate, error) {
	t.Helper()

	var template nicloudsdk.NotificationTemplate
