...
import (
	...
	aibridgedproto "github.com/NeuralInverse/cloud/v2/nicloud/aibridged/proto"
...
// [API]'s router, so that requests to aibridged will be relayed from Neural Inverse Cloud's API server
...
// This server is responsible for all the Neural Inverse Cloud-specific functionality that aibridged
