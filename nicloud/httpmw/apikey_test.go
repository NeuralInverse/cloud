...
import (
	...
	"github.com/NeuralInverse/cloud/v2/nicloud/httpmw/loggermw/loggermock"
...
func TestAPIKey(t *testing.T) {
	...
	successHandler := http.HandlerFunc(func(rw http.ResponseWriter, r *http.Request) {
		...
		httpapi.Write(context.Background(), rw, http.StatusOK, nicloudsdk.Response{
			Message: "It worked!",
		})
	})
	...
	t.Run("InvalidFormat", func(t *testing.T) {
		...
		r.Header.Set(nicloudsdk.SessionTokenHeader, "test-wow-hello")
	...
	t.Run("InvalidIDLength", func(t *testing.T) {
		...
		r.Header.Set(nicloudsdk.SessionTokenHeader, "test-wow")
	...
	t.Run("InvalidSecretLength", func(t *testing.T) {
		...
		r.Header.Set(nicloudsdk.SessionTokenHeader, "testtestid-wow")
	...
	t.Run("NotFound", func(t *testing.T) {
		...
		r.Header.Set(nicloudsdk.SessionTokenHeader, fmt.Sprintf("%s-%s", id, secret))
	...
	t.Run("Expired", func(t *testing.T) {
		...
		var apiRes nicloudsdk.Response
	...
	t.Run("ValidWithScope", func(t *testing.T) {
		...
		httpmw.ExtractAPIKeyMW(httpmw.ExtractAPIKeyConfig{
			...
			assert.Equal(t, database.ApiKeyScopeNIApplicationConnect, apiKey.Scopes[0])
			assertActorOk(t, r)
	...
	t.Run("QueryParameter", func(t *testing.T) {
		...
		q := r.URL.Query()
		q.Add(nicloudsdk.SessionTokenCookie, token)
