...
func TestWorkspaceAgentParam(t *testing.T) {
	...
	t.Run("NotAuthorized", func(t *testing.T) {
		...
		db, _ := dbtestutil.NewDB(t)
		dbtestutil.DisableForeignKeysAndTriggers(t, db)
		fakeAuthz := (&nicloudtest.FakeAuthorizer{}).AlwaysReturn(xerrors.Errorf("constant failure"))
		dbFail := dbauthz.New(db, fakeAuthz, slog.Make(), nicloudtest.AccessControlStorePointer())
