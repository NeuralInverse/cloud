...
func TestCSP(t *testing.T) {
	...
	proxyHosts := []*proxyhealth.ProxyHost{
		...
		},
		{
			...
			AppHost: "*.cloud.neuralinverse.com",
		},
		{
	...
	expected := []string{
		"frame-src 'self' *.test.com *.cloud.neuralinverse.com *.coder2.com",
		...
		strings.Join([]string{
			...
			"wss://cloud.neuralinverse.com", "ws://cloud.neuralinverse.com", "https://cloud.neuralinverse.com", "http://cloud.neuralinverse.com",
		}, " "),
	}
