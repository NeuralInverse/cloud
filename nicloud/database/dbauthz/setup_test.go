...
import (
	...
	"github.com/NeuralInverse/cloud/v2/nicloud/rbac/regosql"
...
func (s *MethodTestSuite) SetupSuite() {
	...
	az := dbauthz.New(mockStore, nil, slog.Make(), nicloudtest.AccessControlStorePointer())
...
func (s *MethodTestSuite) SubtestWithDB(db database.Store, testCaseF func(db database.Store, check *expects)) func() {
	return func() {
		...
		fakeAuthorizer := &nicloudtest.FakeAuthorizer{}
...
func (s *MethodTestSuite) NotAuthorizedErrorTest(ctx context.Context, az *nicloudtest.FakeAuthorizer, testCase expects, callMethod func(ctx context.Context) ([]reflect.Value, error)) {
