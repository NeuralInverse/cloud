...
func TestInsertCustomRoles(t *testing.T) {
	...
	testCases := []struct {
		...
		site           []nicloudsdk.Permission
		org            []nicloudsdk.Permission
		user           []nicloudsdk.Permission
		member         []nicloudsdk.Permission
		...
		},
		{
			...
			site: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				nicloudsdk.ResourceWorkspace: {nicloudsdk.ActionRead},
			}),
			org: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				nicloudsdk.ResourceWorkspace: {nicloudsdk.ActionRead},
			}),
		...
		},
		{
			...
			org: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				...
				nicloudsdk.ResourceWorkspace: {nicloudsdk.ActionViewInsights},
			}),
		...
		},
		{
			...
			subject:        merge(canCreateCustomRole, rbac.RoleOwner()),
			org: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				"foobar": {nicloudsdk.ActionViewInsights},
			}),
		...
		},
		{
			...
			organizationID: orgID,
			subject:        merge(canCreateCustomRole, rbac.ScopedRoleOrgAdmin(orgID)),
			user: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				nicloudsdk.ResourceWorkspace: {nicloudsdk.ActionRead},
			}),
			errorContains: "organization roles specify site or user permissions",
		},
		{
			...
			organizationID: orgID,
			subject:        merge(canCreateCustomRole),
			member: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				nicloudsdk.ResourceWorkspace: {nicloudsdk.ActionRead},
			}),
		...
		},
		{
			...
			site: nicloudsdk.CreatePermissions(map[nicloudsdk.RBACResource][]nicloudsdk.RBACAction{
				nicloudsdk.ResourceDeploymentConfig: {nicloudsdk.ActionUpdate}, // not ok!
			}),
			errorContains: "organization roles specify site or user permissions",
		},
		// ok!
...
func convertSDKPerm(perm nicloudsdk.Permission) database.CustomRolePermission {
