...
func TestAPIKeyScopesExpand(t *testing.T) {
	...
	t.Run("builtins", func(t *testing.T) {
		...
		cases := []struct {
			...
			{
				name:   "all",
				scopes: APIKeyScopes{ApiKeyScopeNIAll},
				want: func(t *testing.T, s rbac.Scope) {
			...
			},
			{
				...
				scopes: APIKeyScopes{ApiKeyScopeNIApplicationConnect},
				want: func(t *testing.T, s rbac.Scope) {
	...
	t.Run("merge", func(t *testing.T) {
		t.Parallel()
		scopes := APIKeyScopes{ApiKeyScopeNIApplicationConnect, ApiKeyScopeNIAll, ApiKeyScopeWorkspaceRead}
