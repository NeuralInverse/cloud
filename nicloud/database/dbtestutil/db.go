...
func NewDB(t testing.TB, opts ...Option) (database.Store, pubsub.Pubsub) {
	...
	connectionURL := os.Getenv("NEURALINVERSE_PG_CONNECTION_URL")
...
//     ./scripts/neuralinverse-dev.sh server --postgres-url='postgres://postgres:postgres@127.0.0.1:5432/<dbname>?sslmode=disable'
