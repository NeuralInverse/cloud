...
type sqlcQuerier interface {
	...
	// of NEURALINVERSE_NOTIFICATIONS_LEASE_PERIOD. Once a message is delivered, its status is updated and the lease expires (set to NULL).
	...
	// and have not connected to nicloud since a week.
	...
	// terminal statuses defined by ChatDebugStatus in nicloudsdk/chats.go.
	//
	...
	// result into nicloudsdk.AdvisorConfig. Returns '{}' when unset so zero
	...
	//
	//   * deleted = false: Neural Inverse Cloud soft-deletes by flipping users.deleted
	...
	// for the experimental chat advisor. Callers marshal nicloudsdk.AdvisorConfig
