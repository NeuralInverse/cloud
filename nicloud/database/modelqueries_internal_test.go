...
// defined by ChatDebugTerminalStatuses in nicloudsdk.  If a new terminal
...
func TestFinalizeStaleChatDebugRows_TerminalStatusAlignment(t *testing.T) {
	...
	goTerminal := nicloudsdk.ChatDebugTerminalStatuses()
	...
	for _, match := range matches {
		...
		require.Equal(t, goStatuses, sqlStatuses,
			"terminal statuses in FinalizeStaleChatDebugRows SQL must match "+
				"nicloudsdk.ChatDebugTerminalStatuses(); update both when adding "+
