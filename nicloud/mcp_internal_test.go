...
// used in production (nicloud.go:370). Without it the test would not
...
// fakeAccessControlStore mirrors nicloudtest.FakeAccessControlStore but is
// inlined here to avoid an import cycle (nicloudtest imports nicloud).
