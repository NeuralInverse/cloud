...
type QueryParamParser struct {
	...
	Errors []nicloudsdk.ValidationError
...
func (p *QueryParamParser) ProvisionerDaemonStatuses(vals url.Values, def []nicloudsdk.ProvisionerDaemonStatus, queryParam string) []nicloudsdk.ProvisionerDaemonStatus {
	return ParseCustomList(p, vals, def, queryParam, func(v string) (nicloudsdk.ProvisionerDaemonStatus, error) {
		return nicloudsdk.ProvisionerDaemonStatus(v), nil
	})
}
