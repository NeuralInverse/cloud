...
import (
	...
	strutil "github.com/NeuralInverse/cloud/v2/nicloud/util/strings"
...
func (a *AppsAPI) UpdateAppStatus(ctx context.Context, req *agentproto.UpdateAppStatusRequest) (*agentproto.UpdateAppStatusResponse, error) {
	if len(req.Message) > 160 {
		return nil, nicloudsdk.NewError(http.StatusBadRequest, nicloudsdk.Response{
	...
	if !ok {
		return nil, nicloudsdk.NewError(http.StatusInternalServerError, nicloudsdk.Response{
