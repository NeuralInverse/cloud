...
func TestUpdateNotificationsSettings(t *testing.T) {
	...
	t.Run("Permissions denied", func(t *testing.T) {
		...
		anotherClient, _ := nicloudtest.CreateAnotherUser(t, api, firstUser.OrganizationID)

		// given
		expected := nicloudsdk.NotificationsSettings{
			NotifierPaused: true,
		}
	...
	t.Run("Settings modified", func(t *testing.T) {
		...
		client := nicloudtest.New(t, createOpts(t))
	...
	t.Run("Settings not modified", func(t *testing.T) {
		...
		err := client.PutNotificationsSettings(ctx, nicloudsdk.NotificationsSettings{
			NotifierPaused: true,
		})
		require.NoError(t, err)
...
func TestNotificationPreferences(t *testing.T) {
	...
	t.Run("Initial state", func(t *testing.T) {
		...
		memberClient, member := nicloudtest.CreateAnotherUser(t, api, firstUser.OrganizationID)
	...
	t.Run("Insufficient permissions", func(t *testing.T) {
		...
		// Given: 2 members.
		_, member1 := nicloudtest.CreateAnotherUser(t, api, firstUser.OrganizationID)
		member2Client, _ := nicloudtest.CreateAnotherUser(t, api, firstUser.OrganizationID)
	...
	t.Run("Admin may read any users' preferences", func(t *testing.T) {
		...
		// Given: a member.
		_, member := nicloudtest.CreateAnotherUser(t, api, firstUser.OrganizationID)
	...
	t.Run("Admin may update any users' preferences", func(t *testing.T) {
		...
		prefs, err := api.UpdateUserNotificationPreferences(ctx, member.ID, nicloudsdk.UpdateUserNotificationPreferences{
	...
	t.Run("Add preferences", func(t *testing.T) {
		...
		prefs, err = memberClient.UpdateUserNotificationPreferences(ctx, member.ID, nicloudsdk.UpdateUserNotificationPreferences{
			TemplateDisabledMap: map[string]bool{
...
func TestNotificationDispatchMethods(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ctx := testutil.Context(t, testutil.WaitSuperLong)
			api := nicloudtest.New(t, tc.opts)
			_ = nicloudtest.CreateFirstUser(t, api)
...
func TestCustomNotification(t *testing.T) {
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		err := memberClient.PostCustomNotification(ctx, nicloudsdk.CustomNotificationRequest{
	...
	t.Run("SystemUserNotAllowed", func(t *testing.T) {
		...
		err := systemUserClient.PostCustomNotification(ctx, nicloudsdk.CustomNotificationRequest{
			Content: &nicloudsdk.CustomNotificationContent{
				Title:   "Custom Title",
