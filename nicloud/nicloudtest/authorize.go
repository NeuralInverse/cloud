...
func AssertRBAC(t *testing.T, api *nicloud.API, client *nicloudsdk.Client) RBACAsserter {
...
// convertObjects converts the nicloudsdk types to rbac.Object. Unfortunately
...
func caller(skip int) string {
	...
	i := strings.Index(file, "neuralinverse")
	if i >= 0 {
		file = file[i:]
	}
