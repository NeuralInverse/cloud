...
func NewLoginHelper(client *nicloudsdk.Client, fake *FakeIDP) *LoginHelper {
	if client == nil {
...
// convenience method.
func (h *LoginHelper) Login(t *testing.T, idTokenClaims jwt.MapClaims) (*nicloudsdk.Client, *http.Response) {
	t.Helper()
	unauthenticatedClient := nicloudsdk.New(h.client.URL)

	return h.fake.Login(t, unauthenticatedClient, idTokenClaims)
}

// AttemptLogin does not assert a successful login.
func (h *LoginHelper) AttemptLogin(t *testing.T, idTokenClaims jwt.MapClaims) (*nicloudsdk.Client, *http.Response) {
	t.Helper()
	unauthenticatedClient := nicloudsdk.New(h.client.URL)
...
func (*LoginHelper) ExpireOauthToken(t *testing.T, db database.Store, user *nicloudsdk.Client) database.UserLink {
	t.Helper()
...
func (h *LoginHelper) ForceRefresh(t *testing.T, db database.Store, user *nicloudsdk.Client, idToken jwt.MapClaims) {
	t.Helper()
