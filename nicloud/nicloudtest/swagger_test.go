...
func TestEndpointsDocumented(t *testing.T) {
	...
	swaggerComments, err := nicloudtest.ParseSwaggerComments("..", "../workspaceconnwatcher")
	...
	nicloudtest.VerifySwaggerDefinitions(t, api.APIHandler, swaggerComments, nicloudtest.WithSwaggerRoutePrefix("/api/v2"))
}
...
func TestSDKFieldsFormatted(t *testing.T) {
	...
	nodes, err := parser.ParseDir(fileSet, "../../nicloudsdk", nil, parser.ParseComments)
