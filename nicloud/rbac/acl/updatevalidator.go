...
type UpdateValidator[Role nicloudsdk.WorkspaceRole | nicloudsdk.TemplateRole | nicloudsdk.ChatRole] interface {
...
func Validate[Role nicloudsdk.WorkspaceRole | nicloudsdk.TemplateRole | nicloudsdk.ChatRole](
	ctx context.Context,
	db database.Store,
