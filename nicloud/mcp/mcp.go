...
const (
	...
	MCPServerName = "Neural Inverse Cloud"
...
func (s *Server) RegisterTools(client *nicloudsdk.Client, opts ...func(*toolsdk.Deps)) error {
	if client == nil {
...
// refuse to add Neural Inverse Cloud as a connector.
func (s *Server) RegisterChatGPTTools(client *nicloudsdk.Client, opts ...func(*toolsdk.Deps)) error {
	if client == nil {
		return xerrors.New("client cannot be nil: MCP HTTP server requires authenticated client")
	}
