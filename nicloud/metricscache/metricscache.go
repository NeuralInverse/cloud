...
type Cache struct {
	...
	deploymentStatsResponse  atomic.Pointer[nicloudsdk.DeploymentStats]
...
func (c *Cache) refreshDeploymentStats(ctx context.Context) error {
	...
	c.deploymentStatsResponse.Store(&nicloudsdk.DeploymentStats{
		AggregatedFrom: from,
		CollectedAt:    dbtime.Time(c.clock.Now()),
		NextUpdateAt:   dbtime.Time(c.clock.Now().Add(c.intervals.DeploymentStats)),
		Workspaces: nicloudsdk.WorkspaceDeploymentStats{
			...
			ConnectionLatencyMS: nicloudsdk.WorkspaceConnectionLatencyMS{
		...
		SessionCount: nicloudsdk.SessionCountDeploymentStats{
...
func (c *Cache) TemplateBuildTimeStats(id uuid.UUID) nicloudsdk.TemplateBuildTimeStats {
	unknown := nicloudsdk.TemplateBuildTimeStats{
		nicloudsdk.WorkspaceTransitionStart:  {},
		nicloudsdk.WorkspaceTransitionStop:   {},
		nicloudsdk.WorkspaceTransitionDelete: {},
	}
	...
	return nicloudsdk.TemplateBuildTimeStats{
		nicloudsdk.WorkspaceTransitionStart: {
...
func (c *Cache) DeploymentStats() (nicloudsdk.DeploymentStats, bool) {
	deploymentStats := c.deploymentStatsResponse.Load()
	if deploymentStats == nil {
		return nicloudsdk.DeploymentStats{}, false
	}
