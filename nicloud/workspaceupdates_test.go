...
func TestWorkspaceUpdates(t *testing.T) {
	...
	t.Run("Basic", func(t *testing.T) {
		...
		updateProvider := nicloud.NewUpdatesProvider(testutil.Logger(t), ps, db, &mockAuthorizer{})
		t.Cleanup(func() {
...
// GetAuthorizedWorkspacesAndAgentsByOwnerID implements nicloud.UpdatesQuerier.
...
// GetWorkspaceByAgentID implements nicloud.UpdatesQuerier.
...
var _ nicloud.UpdatesQuerier = (*mockWorkspaceStore)(nil)
