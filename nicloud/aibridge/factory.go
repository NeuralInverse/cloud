...
// SourceAgents is chatd traffic originating from a Neural Inverse Cloud agent.
...
//
// Implementations live in nicloud/aibridged. nicloud registers an in-process
// factory on nicloud.API.AIBridgeTransportFactory at startup so callers route
