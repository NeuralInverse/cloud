...
var (
	...
	// allowedStoredMediaTypes is derived from nicloudsdk.AllChatAttachmentMediaTypes
	...
	// nicloudsdk const block instead.
	allowedStoredMediaTypes = func() map[string]struct{} {
		m := make(map[string]struct{}, len(nicloudsdk.AllChatAttachmentMediaTypes))
		for _, t := range nicloudsdk.AllChatAttachmentMediaTypes {
			m[string(t)] = struct{}{}
		}
		return m
	}()
