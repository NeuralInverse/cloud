...
// Glossary:
//
//   - Personal skill: A user-owned skill that follows the user across Neural Inverse Cloud
//     chats and workspaces, stored by Neural Inverse Cloud rather than discovered from a
...
// Decision:
//
// Personal skills are stored by Neural Inverse Cloud. For each chat turn, chatd fetches
...
// path, while storage remains owned by Neural Inverse Cloud instead of individual workspace
