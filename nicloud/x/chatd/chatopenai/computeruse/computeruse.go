...
// OpenAI scroll deltas are pixels, but Neural Inverse Cloud desktop scroll amounts are
// wheel clicks.
const computerUseScrollPixelsPerWheelClick int64 = 100

// ComputerUseDesktopAction is a Neural Inverse Cloud desktop operation requested by an
...
// Neural Inverse Cloud desktop actions. A caller should execute the returned actions in order,
...
// DoubleClickAction maps an OpenAI computer-use double-click button to a Neural Inverse Cloud
...
// ComputerUseClickAction maps an OpenAI computer-use click button to a Neural Inverse Cloud
// desktop action name.
...
// NormalizeComputerUseKeys maps OpenAI keypress tokens to Neural Inverse Cloud desktop key
// action tokens.
