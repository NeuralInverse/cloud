...
func buildErrorCode(err error) nicloudsdk.JobErrorCode {
...
type quotaErrorResult struct {
	ErrorCode nicloudsdk.JobErrorCode `json:"error_code"`
...
func newQuotaError(
	...
	r := quotaErrorResult{
		ErrorCode: nicloudsdk.InsufficientQuota,
		Error:     msg,
...
func buildFailureToolResponse(
	...
	msg := err.Error()
	if nicloudsdk.JobIsInsufficientQuotaErrorCode(buildErrorCode(err)) {
