...
type openAICompatRequestPatchTransport struct {
	...
	BaseURL string
	// ModelID is the configured model ID, used to detect Gemini routes through Neural Inverse Cloud AI Bridge.
	ModelID string
}
...
// endpoints and Neural Inverse Cloud AI Bridge Gemini routes. Other gateways, such as Vercel,
