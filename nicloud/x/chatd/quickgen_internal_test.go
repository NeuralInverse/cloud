...
func Test_extractManualTitleTurns(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			messages: []database.ChatMessage{
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "  review quickgen helpers  "},
				),
				mustChatMessage(t, database.ChatMessageRoleAssistant, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "  drafted a plan  "},
				),
				mustChatMessage(t, database.ChatMessageRoleSystem, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "system prompt"},
				),
				mustChatMessage(t, database.ChatMessageRoleTool, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "tool output"},
				),
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityModel,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "hidden model note"},
				),
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "   "},
				),
				mustChatMessage(t, database.ChatMessageRoleAssistant, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeReasoning, Text: "reasoning only"},
				),
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeFile, MediaType: "text/plain"},
				),
			},
			want: []manualTitleTurn{
		...
		},
		{
			...
			messages: []database.ChatMessage{
				mustChatMessage(t, database.ChatMessageRoleUser, database.ChatMessageVisibilityBoth,
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: "first chunk"},
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeReasoning, Text: "skip me"},
					nicloudsdk.ChatMessagePart{Type: nicloudsdk.ChatMessagePartTypeText, Text: " second chunk "},
				),
			},
...
func Test_generateManualTitle_UsesTimeout(t *testing.T) {
	...
	messages := []database.ChatMessage{
		mustChatMessage(
			...
			database.ChatMessageRoleUser,
			database.ChatMessageVisibilityBoth,
			nicloudsdk.ChatMessageText("refresh chat title"),
		),
	}
...
func Test_generateManualTitle_TruncatesFirstUserInput(t *testing.T) {
	...
	messages := []database.ChatMessage{
		mustChatMessage(
			...
			database.ChatMessageRoleUser,
			database.ChatMessageVisibilityBoth,
			nicloudsdk.ChatMessageText(longFirstUserText),
		),
	}
