...
import (
	...
	"github.com/NeuralInverse/cloud/v2/nicloud/database/provisionerjobs"
	...
	"github.com/NeuralInverse/cloud/v2/nicloud/wspubsub"
...
// @Success 200 {object} nicloudsdk.Workspace
...
func (api *API) workspace(rw http.ResponseWriter, r *http.Request) {
	...
	if workspace.Deleted && !showDeleted {
		httpapi.Write(ctx, rw, http.StatusGone, nicloudsdk.Response{
	...
	appStatus := nicloudsdk.WorkspaceAppStatus{}
...
// @Success 200 {object} nicloudsdk.WorkspacesResponse
...
func (api *API) workspaces(rw http.ResponseWriter, r *http.Request) {
	...
	if len(workspaceRows) == 1 {
		httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.WorkspacesResponse{
...
// @Param request body nicloudsdk.CreateWorkspaceRequest true "Create workspace request"
// @Success 200 {object} nicloudsdk.Workspace
...
func (api *API) postWorkspacesByOrganization(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.CreateWorkspaceRequest
...
func createWorkspace(
	...
	if !api.HTTPAuth.AuthorizeContext(ctx, policy.ActionCreate,
		...
		// what is going on.
		return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusForbidden, nicloudsdk.Response{
	...
	if !api.HTTPAuth.AuthorizeContext(ctx, policy.ActionCreate,
		rbac.ResourceWorkspace.InOrg(template.OrganizationID).WithOwner(owner.ID.String())) {
		return nicloudsdk.Workspace{}, httperror.ErrResourceNotFound
	}
	...
	if templateAccessControl.IsDeprecated() {
		return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, nicloudsdk.Response{
	...
	if err != nil {
		return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, nicloudsdk.Response{
			...
			Validations: []nicloudsdk.ValidationError{{Field: "schedule", Detail: err.Error()}},
		})
	}

	templateSchedule, err := (*api.TemplateScheduleStore.Load()).Get(ctx, api.Database, template.ID)
	if err != nil {
		return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusInternalServerError, nicloudsdk.Response{
	...
	if err != nil {
		return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, nicloudsdk.Response{
			...
			Validations: []nicloudsdk.ValidationError{{Field: "ttl_ms", Detail: err.Error()}},
		})
	}
	...
	if req.AutomaticUpdates != "" {
		...
		if err != nil {
			return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusBadRequest, nicloudsdk.Response{
				...
				Validations: []nicloudsdk.ValidationError{{Field: "automatic_updates", Detail: err.Error()}},
			})
		}
	}
	...
	if err == nil {
		...
		return nicloudsdk.Workspace{}, httperror.NewResponseError(http.StatusConflict, nicloudsdk.Response{
...
func requestTemplate(ctx context.Context, req nicloudsdk.CreateWorkspaceRequest, db database.Store) (database.Template, error) {
	...
	if templateID == uuid.Nil {
		...
		if httpapi.Is404Error(err) {
			return database.Template{}, httperror.NewResponseError(http.StatusBadRequest, nicloudsdk.Response{
		...
		if err != nil {
			return database.Template{}, httperror.NewResponseError(http.StatusInternalServerError, nicloudsdk.Response{
	...
	if template.Deleted {
		return database.Template{}, httperror.NewResponseError(http.StatusNotFound, nicloudsdk.Response{
...
func (api *API) notifyWorkspaceCreated(
	...
	parameters []nicloudsdk.WorkspaceBuildParameter,
) {
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.UpdateWorkspaceRequest true "Metadata update request"
// @Success 204
...
func (api *API) patchWorkspace(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateWorkspaceRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if err != nil {
		...
		if errors.Is(err, sql.ErrNoRows) {
			httpapi.Write(ctx, rw, http.StatusMethodNotAllowed, nicloudsdk.Response{
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.UpdateWorkspaceAutostartRequest true "Schedule update request"
// @Success 204
...
func (api *API) putWorkspaceAutostart(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateWorkspaceAutostartRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if !templateSchedule.UserAutostartEnabled {
		httpapi.Write(ctx, rw, http.StatusBadRequest, nicloudsdk.Response{
			...
			Validations: []nicloudsdk.ValidationError{{Field: "schedule", Detail: "Autostart is not allowed for workspaces using this template."}},
		})
		return
	}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.UpdateWorkspaceTTLRequest true "Workspace TTL update request"
// @Success 204
...
func (api *API) putWorkspaceTTL(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateWorkspaceTTLRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	err := api.Database.InTx(func(s database.Store) error {
		...
		if !templateSchedule.UserAutostopEnabled {
			return nicloudsdk.ValidationError{Field: "ttl_ms", Detail: "Custom autostop TTL is not allowed for workspaces using this template."}
		}
		...
		if validityErr != nil {
			return nicloudsdk.ValidationError{Field: "ttl_ms", Detail: validityErr.Error()}
		}
	...
	if err != nil {
		...
		var validErr nicloudsdk.ValidationError
		if errors.As(err, &validErr) {
			resp.Validations = []nicloudsdk.ValidationError{validErr}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.UpdateWorkspaceDormancy true "Make a workspace dormant or active"
// @Success 200 {object} nicloudsdk.Workspace
...
func (api *API) putWorkspaceDormant(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateWorkspaceDormancy
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.PutExtendWorkspaceRequest true "Extend deadline update request"
...
func (api *API) putExtendWorkspace(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.PutExtendWorkspaceRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Accept json
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.PostWorkspaceUsageRequest false "Post workspace usage request"
// @Success 204
...
func (api *API) postWorkspaceUsage(rw http.ResponseWriter, r *http.Request) {
	...
	if !api.Experiments.Enabled(nicloudsdk.ExperimentWorkspaceUsage) {
	...
	ctx := r.Context()
	var req nicloudsdk.PostWorkspaceUsageRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if !slices.Contains(nicloudsdk.AllowedAppNames, req.AppName) {
		httpapi.Write(ctx, rw, http.StatusBadRequest, nicloudsdk.Response{
			Message: "Invalid request",
			Validations: []nicloudsdk.ValidationError{{
				Field:  "app_name",
				Detail: fmt.Sprintf("must be one of %v", nicloudsdk.AllowedAppNames),
			}},
		})
		return
	}
	...
	switch req.AppName {
	case nicloudsdk.UsageAppNameVscode:
		stat.SessionCountVscode = 1
	case nicloudsdk.UsageAppNameJetbrains:
		stat.SessionCountJetbrains = 1
	case nicloudsdk.UsageAppNameReconnectingPty:
		stat.SessionCountReconnectingPty = 1
	case nicloudsdk.UsageAppNameSSH:
		stat.SessionCountSsh = 1
	default:
		// This means the app_name is in the nicloudsdk.AllowedAppNames but not being
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.UpdateWorkspaceAutomaticUpdatesRequest true "Automatic updates request"
// @Success 204
...
func (api *API) putWorkspaceAutoupdates(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateWorkspaceAutomaticUpdatesRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	if !database.AutomaticUpdates(req.AutomaticUpdates).Valid() {
		httpapi.Write(ctx, rw, http.StatusBadRequest, nicloudsdk.Response{
			Message:     "Invalid request",
			Validations: []nicloudsdk.ValidationError{{Field: "automatic_updates", Detail: "must be always or never"}},
		})
		return
	}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} nicloudsdk.ResolveAutostartResponse
...
func (api *API) resolveAutostart(rw http.ResponseWriter, r *http.Request) {
	...
	if !useActiveVersion {
		httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.ResolveAutostartResponse{})
		return
	}
	...
	resolver := nicloudsdk.ParameterResolver{
		Rich: db2sdk.WorkspaceBuildParameters(dbBuildParams),
	}

	var response nicloudsdk.ResolveAutostartResponse
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} nicloudsdk.ServerSentEvent
...
func (api *API) watchWorkspace(
	...
	sendUpdate := func(_ context.Context, _ []byte) {
		...
		if err != nil {
			_ = sendEvent(nicloudsdk.ServerSentEvent{
				Type: nicloudsdk.ServerSentEventTypeError,
				Data: nicloudsdk.Response{
					Message: "Internal error fetching workspace.",
					Detail:  err.Error(),
				},
			})
		...
		_ = sendEvent(nicloudsdk.ServerSentEvent{
			Type: nicloudsdk.ServerSentEventTypeData,
			Data: w,
		})
	}
	...
	_ = sendEvent(nicloudsdk.ServerSentEvent{
		Type: nicloudsdk.ServerSentEventTypePing,
	})
...
func (api *API) watchAllWorkspaceBuilds(rw http.ResponseWriter, r *http.Request) {
	...
	updates := make(chan nicloudsdk.WorkspaceBuildUpdate, 256)

	cancelSubscribe, err := api.Pubsub.SubscribeWithErr(wspubsub.AllWorkspaceEventChannel,
		wspubsub.HandleWorkspaceBuildUpdate(
			func(_ context.Context, update nicloudsdk.WorkspaceBuildUpdate, err error) {
				if err != nil {
	...
	enc := wsjson.NewEncoder[nicloudsdk.WorkspaceBuildUpdate](conn, websocket.MessageText)
	for {
		select {
		case <-ctx.Done():
			return
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} nicloudsdk.WorkspaceBuildTimings
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Success 200 {object} nicloudsdk.WorkspaceACL
...
func (api *API) workspaceACL(rw http.ResponseWriter, r *http.Request) {
	...
	// Convert the db types to the nicloudsdk.WorkspaceUser type
	users := make([]nicloudsdk.WorkspaceUser, 0, len(dbUsers))
	for _, it := range dbUsers {
		users = append(users, nicloudsdk.WorkspaceUser{
	...
	groups := make([]nicloudsdk.WorkspaceGroup, 0, len(dbGroups))
	for _, it := range dbGroups {
		...
		groups = append(groups, nicloudsdk.WorkspaceGroup{
	...
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.WorkspaceACL{
		Users:  users,
		Groups: groups,
	})
}
...
// @Tags Workspaces
// @Param workspace path string true "Workspace ID" format(uuid)
// @Param request body nicloudsdk.UpdateWorkspaceACL true "Update workspace ACL request"
// @Success 204
...
func (api *API) patchWorkspaceACL(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateWorkspaceACL
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	err := api.Database.InTx(func(tx database.Store) error {
		...
		for id, role := range req.UserRoles {
			if role == nicloudsdk.WorkspaceRoleDeleted {
...
type workspaceData struct {
	...
	builds       []nicloudsdk.WorkspaceBuild
	appStatuses  []nicloudsdk.WorkspaceAppStatus
	allowRenames bool
}
...
func convertWorkspaces(
	...
	buildByWorkspaceID := map[uuid.UUID]nicloudsdk.WorkspaceBuild{}
	...
	appStatusesByWorkspaceID := map[uuid.UUID]nicloudsdk.WorkspaceAppStatus{}
	for _, appStatus := range data.appStatuses {
		appStatusesByWorkspaceID[appStatus.WorkspaceID] = appStatus
	}

	apiWorkspaces := make([]nicloudsdk.Workspace, 0, len(workspaces))
	for _, workspace := range workspaces {
...
func convertWorkspace(
	...
	requesterID uuid.UUID,
	workspace database.Workspace,
	workspaceBuild nicloudsdk.WorkspaceBuild,
	template database.Template,
	allowRenames bool,
	latestAppStatus nicloudsdk.WorkspaceAppStatus,
) (nicloudsdk.Workspace, error) {
	if requesterID == uuid.Nil {
		return nicloudsdk.Workspace{}, xerrors.Errorf("developer error: requesterID cannot be uuid.Nil!")
	}
	...
	return nicloudsdk.Workspace{
		...
		DormantAt:                            dormantAt,
		Health: nicloudsdk.WorkspaceHealth{
			Healthy:       len(failingAgents) == 0,
			FailingAgents: failingAgents,
		},
		AutomaticUpdates: nicloudsdk.AutomaticUpdates(workspace.AutomaticUpdates),
...
func sharedWorkspaceActors(
	...
	out := make([]nicloudsdk.SharedWorkspaceActor, 0, len(workspace.UserACL)+len(workspace.GroupACL))
	...
	for id, aclEntry := range workspace.UserACL {
		...
		out = append(out, nicloudsdk.SharedWorkspaceActor{
			ID:        userID,
			ActorType: nicloudsdk.SharedWorkspaceActorTypeUser,
			Roles:     []nicloudsdk.WorkspaceRole{convertToWorkspaceRole(aclEntry.Permissions)},
	...
	for id, aclEntry := range workspace.GroupACL {
		...
		out = append(out, nicloudsdk.SharedWorkspaceActor{
			ID:        groupID,
			ActorType: nicloudsdk.SharedWorkspaceActorTypeGroup,
			Roles:     []nicloudsdk.WorkspaceRole{convertToWorkspaceRole(aclEntry.Permissions)},
...
func validWorkspaceAutomaticUpdates(updates nicloudsdk.AutomaticUpdates) (database.AutomaticUpdates, error) {
	if updates == "" {
...
type WorkspaceACLUpdateValidator nicloudsdk.UpdateWorkspaceACL
...
// WorkspaceACLUpdateValidator implements acl.UpdateValidator[nicloudsdk.WorkspaceRole]
var _ acl.UpdateValidator[nicloudsdk.WorkspaceRole] = WorkspaceACLUpdateValidator{}

func (w WorkspaceACLUpdateValidator) Users() (map[string]nicloudsdk.WorkspaceRole, string) {
	return w.UserRoles, workspaceACLUpdateUsersFieldName
}

func (w WorkspaceACLUpdateValidator) Groups() (map[string]nicloudsdk.WorkspaceRole, string) {
	return w.GroupRoles, workspaceACLUpdateGroupsFieldName
}

func (WorkspaceACLUpdateValidator) ValidateRole(role nicloudsdk.WorkspaceRole) error {
	actions := db2sdk.WorkspaceRoleActions(role)
	if len(actions) == 0 && role != nicloudsdk.WorkspaceRoleDeleted {
...
func convertToWorkspaceRole(actions []policy.Action) nicloudsdk.WorkspaceRole {
	switch {
	case slice.SameElements(actions, db2sdk.WorkspaceRoleActions(nicloudsdk.WorkspaceRoleAdmin)):
		return nicloudsdk.WorkspaceRoleAdmin
	case slice.SameElements(actions, db2sdk.WorkspaceRoleActions(nicloudsdk.WorkspaceRoleUse)):
		return nicloudsdk.WorkspaceRoleUse
	}

	return nicloudsdk.WorkspaceRoleDeleted
}
...
// @Success 200 {array} nicloudsdk.MinimalUser
...
func (api *API) workspaceAvailableUsers(rw http.ResponseWriter, r *http.Request) {
	...
	minimalUsers := make([]nicloudsdk.MinimalUser, 0, len(users))
	for _, user := range users {
		minimalUsers = append(minimalUsers, nicloudsdk.MinimalUser{
			ID:        user.ID,
