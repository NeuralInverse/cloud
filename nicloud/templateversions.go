...
// @Success 200 {object} nicloudsdk.TemplateVersion
...
func (api *API) templateVersion(rw http.ResponseWriter, r *http.Request) {
	...
	var matchedProvisioners *nicloudsdk.MatchedProvisioners
	...
	var warnings []nicloudsdk.TemplateVersionWarning
	if len(schemas) > 0 {
		warnings = append(warnings, nicloudsdk.TemplateVersionWarningUnsupportedWorkspaces)
	}
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param request body nicloudsdk.PatchTemplateVersionRequest true "Patch template version request"
// @Success 200 {object} nicloudsdk.TemplateVersion
...
func (api *API) patchTemplateVersion(rw http.ResponseWriter, r *http.Request) {
	...
	var params nicloudsdk.PatchTemplateVersionRequest
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Success 200 {array} nicloudsdk.TemplateVersionParameter
...
func (api *API) templateVersionRichParameters(rw http.ResponseWriter, r *http.Request) {
	...
	if !job.CompletedAt.Valid {
		httpapi.Write(ctx, rw, http.StatusTooEarly, nicloudsdk.Response{
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Success 200 {array} nicloudsdk.TemplateVersionExternalAuth
...
func (api *API) templateVersionExternalAuth(rw http.ResponseWriter, r *http.Request) {
	...
	providers := make([]nicloudsdk.TemplateVersionExternalAuth, 0)
	for _, rawProvider := range rawProviders {
		...
		provider := nicloudsdk.TemplateVersionExternalAuth{
			ID:              config.ID,
			Type:            config.Type,
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Success 200 {array} nicloudsdk.TemplateVersionVariable
...
// @Tags Templates
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param request body nicloudsdk.CreateTemplateVersionDryRunRequest true "Dry-run request"
// @Success 201 {object} nicloudsdk.ProvisionerJob
...
func (api *API) postTemplateVersionDryRun(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.CreateTemplateVersionDryRunRequest
...
// @Success 200 {object} nicloudsdk.ProvisionerJob
...
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param jobID path string true "Job ID" format(uuid)
// @Success 200 {object} nicloudsdk.MatchedProvisioners
...
// @Param templateversion path string true "Template version ID" format(uuid)
// @Param jobID path string true "Job ID" format(uuid)
// @Success 200 {array} nicloudsdk.WorkspaceResource
...
// @Success 200 {array} nicloudsdk.TemplateVersion
...
func (api *API) templateVersionsByTemplate(rw http.ResponseWriter, r *http.Request) {
	...
	var err error
	apiVersions := []nicloudsdk.TemplateVersion{}
...
// @Tags Templates
// @Param template path string true "Template ID" format(uuid)
// @Param request body nicloudsdk.ArchiveTemplateVersionsRequest true "Archive request"
// @Success 200 {object} nicloudsdk.Response
...
func (api *API) postArchiveTemplateVersions(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.ArchiveTemplateVersionsRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
	...
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.ArchiveTemplateVersionsResponse{
		TemplateID:  template.ID,
...
// @Produce json
// @Tags Templates
// @Param request body nicloudsdk.UpdateActiveTemplateVersion true "Modified template version"
// @Param template path string true "Template ID" format(uuid)
// @Success 200 {object} nicloudsdk.Response
...
func (api *API) patchActiveTemplateVersion(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateActiveTemplateVersion
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
// @Tags Templates
// @Param organization path string true "Organization ID" format(uuid)
// @Param request body nicloudsdk.CreateTemplateVersionRequest true "Create template version request"
// @Success 201 {object} nicloudsdk.TemplateVersion
...
func (api *API) postTemplateVersionsByOrganization(rw http.ResponseWriter, r *http.Request) {
	...
	// Ensure the "owner" tag is properly applied in addition to request tags and ni_workspace_tags.
	// User-specified tags in the request will take precedence over tags parsed from `ni_workspace_tags`
...
func (api *API) dynamicTemplateVersionTags(ctx context.Context, rw http.ResponseWriter, orgID uuid.UUID, owner uuid.UUID, file database.File, templateVariables []nicloudsdk.VariableValue) (map[string]string, bool) {
...
// provisioned, each resource can have an agent that dials back to nicloud. The
...
func convertTemplateVersion(version database.TemplateVersion, job nicloudsdk.ProvisionerJob, matchedProvisioners *nicloudsdk.MatchedProvisioners, warnings []nicloudsdk.TemplateVersionWarning) nicloudsdk.TemplateVersion {
	return nicloudsdk.TemplateVersion{
		...
		CreatedBy: nicloudsdk.MinimalUser{
...
func convertTemplateVersionVariables(dbVariables []database.TemplateVersionVariable) []nicloudsdk.TemplateVersionVariable {
	variables := make([]nicloudsdk.TemplateVersionVariable, 0)
...
func convertTemplateVersionVariable(variable database.TemplateVersionVariable) nicloudsdk.TemplateVersionVariable {
	templateVariable := nicloudsdk.TemplateVersionVariable{
		Name:         variable.Name,
