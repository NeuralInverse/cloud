...
// able to validate without having to get a new Neural Inverse Cloud binary. macOS support for
// nicloud is only intended for development and testing, so this is a small trade
// off.
