...
import (
	...
	clitelemetry "github.com/NeuralInverse/cloud/v2/cli/telemetry"
...
const (
	...
	// report the semantic version of Neural Inverse Cloud.
...
type Options struct {
	...
	DeploymentID     string
	DeploymentConfig *nicloudsdk.DeploymentValues
...
func (r *remoteReporter) deployment() error {
	...
	// Tracks where Neural Inverse Cloud was installed from!
	installSource := os.Getenv("NEURALINVERSE_TELEMETRY_INSTALL_SOURCE")
...
// https://github.com/coder/coder/blob/5c6578d84e2940b9cfd04798c45e7c8042c3fe0e/nicloud/idpsync/organization.go#L148
type idpOrgSyncConfig struct {
	Field string `json:"field"`
}

// checkIDPOrgSync inspects the server flags and the runtime config. It's based on
// the OrganizationSyncEnabled function from enterprise/nicloud/enidpsync/organizations.go.
...
// order of the neuralinverse server.
//
...
func checkIDPOrgSync(ctx context.Context, db database.Store, values *nicloudsdk.DeploymentValues) (bool, error) {
	// key based on https://github.com/coder/coder/blob/5c6578d84e2940b9cfd04798c45e7c8042c3fe0e/nicloud/idpsync/idpsync.go#L168
...
func (r *remoteReporter) createSnapshot() (*Snapshot, error) {
	...
	eg.Go(func() error {
		if r.options.DeploymentConfig != nil && slices.Contains(r.options.DeploymentConfig.Experiments, string(nicloudsdk.ExperimentWorkspaceUsage)) {
...
func shouldSendRawModuleSource(source string) bool {
	return strings.Contains(source, "registry.cloud.neuralinverse.com")
}
...
func GetModuleSourceType(source string) ModuleSourceType {
	...
	if strings.Contains(source, "registry.cloud.neuralinverse.com") {
...
func ConvertTemplate(dbTemplate database.Template) Template {
	return Template{
		...
		AutostopRequirementDaysOfWeek: nicloudsdk.BitmapToWeekdays(uint8(dbTemplate.AutostopRequirementDaysOfWeek)),
		AutostopRequirementWeeks:      dbTemplate.AutostopRequirementWeeks,
		AutostartAllowedDays:          nicloudsdk.BitmapToWeekdays(dbTemplate.AutostartAllowedDays()),
...
// Deployment contains information about the host running Neural Inverse Cloud.
type Deployment struct {
	...
	Config          *nicloudsdk.DeploymentValues `json:"config"`
	...
	// the struct backwards compatible with older neuralinverse versions.
...
type NetworkEvent struct {
	...
	ClientType     string                  `json:"client_type"` // cli, agent, nicloud, wsproxy
...
type UserTailnetConnection struct {
	...
	NIDesktopVersion *string    `json:"coder_desktop_version"`
}
