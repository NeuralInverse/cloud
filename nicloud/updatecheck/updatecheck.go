...
// for updates to Neural Inverse Cloud.
//
// The update check is performed by querying the GitHub API for the
// latest release of Neural Inverse Cloud.
package updatecheck
...
const (
	// defaultURL defines the URL to check for the latest version of Neural Inverse Cloud.
...
type Options struct {
	...
	Client *http.Client
	// URL is the URL to check for the latest version of Neural Inverse Cloud,
	...
	// Notify is called when a newer version of Neural Inverse Cloud (than the
	// last update check) is available.
	Notify func(r Result)
}

// New returns a new Checker that periodically checks for Neural Inverse Cloud updates.
...
// Latest returns the latest version of Neural Inverse Cloud.
