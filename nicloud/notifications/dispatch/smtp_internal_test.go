...
func TestValidateFromAddr(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			input:            "system@cloud.neuralinverse.com",
			expectedEnvelope: "system@cloud.neuralinverse.com",
			expectedHeader:   "system@cloud.neuralinverse.com",
		},
		{
			name:             "email with display name",
			input:            "Coder System <system@cloud.neuralinverse.com>",
			expectedEnvelope: "system@cloud.neuralinverse.com",
			expectedHeader:   "Coder System <system@cloud.neuralinverse.com>",
		},
		{
			name:             "email with quoted display name",
			input:            `"Coder Notifications" <notifications@cloud.neuralinverse.com>`,
			expectedEnvelope: "notifications@cloud.neuralinverse.com",
			expectedHeader:   `"Coder Notifications" <notifications@cloud.neuralinverse.com>`,
		},
		{
