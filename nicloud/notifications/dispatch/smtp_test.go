...
func TestSMTP(t *testing.T) {
	...
	tests := []struct {
		name             string
		cfg              nicloudsdk.NotificationsEmailConfig
		toAddrs          []string
		authMechs        []string
		...
		},
		{
			...
			cfg: nicloudsdk.NotificationsEmailConfig{
				...
				From:     from,
				ForceTLS: true,
				TLS: nicloudsdk.NotificationsEmailTLSConfig{
...
func TestSMTPEnvelopeAndHeaders(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fromConfig:         "system@cloud.neuralinverse.com",
			expectedEnvFrom:    "system@cloud.neuralinverse.com",
			expectedHeaderFrom: "system@cloud.neuralinverse.com",
		},
		{
			name:               "email with display name",
			fromConfig:         "Coder System <system@cloud.neuralinverse.com>",
			expectedEnvFrom:    "system@cloud.neuralinverse.com",
			expectedHeaderFrom: "Coder System <system@cloud.neuralinverse.com>",
		},
		{
			name:               "email with quoted display name",
			fromConfig:         `"Coder Notifications" <notifications@cloud.neuralinverse.com>`,
			expectedEnvFrom:    "notifications@cloud.neuralinverse.com",
			expectedHeaderFrom: `"Coder Notifications" <notifications@cloud.neuralinverse.com>`,
		},
	}
