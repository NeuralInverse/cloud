...
func defaultNotificationsConfig(method database.NotificationMethod) nicloudsdk.NotificationsConfig {
	var (
		smtp    nicloudsdk.NotificationsEmailConfig
		webhook nicloudsdk.NotificationsWebhookConfig
	)
	...
	return nicloudsdk.NotificationsConfig{
		...
		SMTP:                smtp,
		Webhook:             webhook,
		Inbox: nicloudsdk.NotificationsInboxConfig{
...
func defaultHelpers() map[string]any {
	return map[string]any{
		...
		"logo_url":     func() string { return "https://cloud.neuralinverse.com/coder-logo-horizontal.png" },
