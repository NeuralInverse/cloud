...
func newNotifier(outerCtx context.Context, cfg nicloudsdk.NotificationsConfig, id uuid.UUID, log slog.Logger, db Store,
...
//
// NOTE: it is _possible_ that these goroutines could block for long enough to exceed NEURALINVERSE_NOTIFICATIONS_DISPATCH_TIMEOUT,
