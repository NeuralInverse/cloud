...
// @Accept json
// @Produce json
// @Param request body nicloudsdk.DynamicParametersRequest true "Initial parameter values"
// @Success 200 {object} nicloudsdk.DynamicParametersResponse
...
func (api *API) templateVersionDynamicParametersEvaluate(rw http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	var req nicloudsdk.DynamicParametersRequest
...
func (api *API) templateVersionDynamicParametersWebsocket(rw http.ResponseWriter, r *http.Request) {
	...
	if qUserID != "" && qUserID != nicloudsdk.Me {
	...
	api.templateVersionDynamicParameters(true, nicloudsdk.DynamicParametersRequest{
		ID:      -1,
...
func (api *API) templateVersionDynamicParameters(listen bool, initial nicloudsdk.DynamicParametersRequest) func(rw http.ResponseWriter, r *http.Request) {
...
func (*API) handleParameterEvaluate(rw http.ResponseWriter, r *http.Request, initial nicloudsdk.DynamicParametersRequest, render dynamicparameters.Renderer) {
	ctx := r.Context()

	// Send an initial form state, computed without any user input.
	result, diagnostics := render.Render(ctx, initial.OwnerID, initial.Inputs)
	response := nicloudsdk.DynamicParametersResponse{
		ID:          0,
...
func (api *API) handleParameterWebsocket(rw http.ResponseWriter, r *http.Request, initial nicloudsdk.DynamicParametersRequest, render dynamicparameters.Renderer) {
	ctx, cancel := context.WithTimeout(r.Context(), 30*time.Minute)
	defer cancel()

	conn, err := websocket.Accept(rw, r, nil)
	if err != nil {
		httpapi.Write(ctx, rw, http.StatusUpgradeRequired, nicloudsdk.Response{
	...
	stream := wsjson.NewStream[nicloudsdk.DynamicParametersRequest, nicloudsdk.DynamicParametersResponse](
		conn,
