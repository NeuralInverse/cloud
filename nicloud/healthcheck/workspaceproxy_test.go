...
func TestWorkspaceProxies(t *testing.T) {
	...
	for _, tt := range []struct {
		name                  string
		fetchWorkspaceProxies func(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error)
		...
		},
		{
			...
			fetchWorkspaceProxies: func(ctx context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
				return nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy]{
					Regions: []nicloudsdk.WorkspaceProxy{
						{
							Region: nicloudsdk.Region{
								Name:    "gone",
								Healthy: false,
							},
							Status: nicloudsdk.WorkspaceProxyStatus{
								Status: nicloudsdk.ProxyUnreachable,
		...
		},
		{
			...
			fetchWorkspaceProxies: fakeFetchWorkspaceProxies(fakeWorkspaceProxy("alpha", false, func(wp *nicloudsdk.WorkspaceProxy) {
				wp.Deleted = true
			})),
			updateProxyHealth: fakeUpdateProxyHealth(nil),
			expectedHealthy:   true,
		...
		},
		{
			...
			fetchWorkspaceProxies: fakeFetchWorkspaceProxies(
				fakeWorkspaceProxy("alpha", true, func(wp *nicloudsdk.WorkspaceProxy) {
		...
		},
		{
			...
			fetchWorkspaceProxies: fakeFetchWorkspaceProxies(
				fakeWorkspaceProxy("alpha", false),
				fakeWorkspaceProxy("beta", false, func(wp *nicloudsdk.WorkspaceProxy) {
					wp.Status.Report.Warnings = []string{"warning"}
				}),
			),
			updateProxyHealth: fakeUpdateProxyHealth(nil),
...
func (u *fakeWorkspaceProxyFetchUpdater) Fetch(ctx context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
...
func fakeWorkspaceProxy(name string, healthy bool, mutators ...func(*nicloudsdk.WorkspaceProxy)) nicloudsdk.WorkspaceProxy {
	var status nicloudsdk.WorkspaceProxyStatus
	if !healthy {
		status = nicloudsdk.WorkspaceProxyStatus{
			Status: nicloudsdk.ProxyUnreachable,
			Report: nicloudsdk.ProxyHealthReport{
...
func fakeFetchWorkspaceProxies(ps ...nicloudsdk.WorkspaceProxy) func(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
	return func(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
		return nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy]{
			Regions: ps,
		}, nil
	}
...
func fakeFetchWorkspaceProxiesErr(err error) func(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
	return func(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
		return nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy]{
			Regions: []nicloudsdk.WorkspaceProxy{},
		}, err
