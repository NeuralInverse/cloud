...
type WorkspaceProxiesFetchUpdater interface {
	Fetch(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error)
...
func (*AGPLWorkspaceProxiesFetchUpdater) Fetch(context.Context) (nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy], error) {
	return nicloudsdk.RegionsResponse[nicloudsdk.WorkspaceProxy]{}, nil
}
...
func (r *WorkspaceProxyReport) Run(ctx context.Context, opts *WorkspaceProxyReportOptions) {
	...
	if r.WorkspaceProxies.Regions == nil {
		r.WorkspaceProxies.Regions = make([]nicloudsdk.WorkspaceProxy, 0)
	}
