...
// Compile-time check.
var _ nicloud.ProfileCollector = noopProfileCollector{}
...
func newTestAPI(t *testing.T) (*nicloudsdk.Client, io.Closer, *nicloud.API) {
	t.Helper()
	client, closer, api := nicloudtest.NewWithAPI(t, nil)
...
func TestDebugCollectProfile(t *testing.T) {
	...
	t.Run("Defaults", func(t *testing.T) {
		...
		asserter := nicloudtest.AssertRBAC(t, api, client)
	...
	t.Run("Unauthorized", func(t *testing.T) {
		...
		memberClient, _ := nicloudtest.CreateAnotherUser(t, client, firstUser.OrganizationID)
