...
func TestResolveTemplateMetaUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Name",
			req:  nicloudsdk.UpdateTemplateMeta{Name: ptr.Ref("renamed")},
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{Name: ptr.Ref("")},
		...
		{
			name: "DisplayName",
			req:  nicloudsdk.UpdateTemplateMeta{DisplayName: ptr.Ref("Renamed")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		{
			name: "Description",
			req:  nicloudsdk.UpdateTemplateMeta{Description: ptr.Ref("New description")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		{
			name: "Icon",
			req:  nicloudsdk.UpdateTemplateMeta{Icon: ptr.Ref("/new.svg")},
			expected: expected{override: func(r *templateMetaUpdate) {
				r.icon = "/new.svg"
			}},
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DefaultTTLMillis: ptr.Ref(int64(7200_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DefaultTTLMillis: ptr.Ref(int64(0))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{ActivityBumpMillis: ptr.Ref(int64(900_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{AllowUserAutostart: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{AllowUserAutostop: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{AllowUserAutostop: ptr.Ref(false)},
			expected: expected{
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{AllowUserCancelWorkspaceJobs: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{FailureTTLMillis: ptr.Ref(int64(3_600_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{TimeTilDormantMillis: ptr.Ref(int64(7_200_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{TimeTilDormantAutoDeleteMillis: ptr.Ref(int64(14_400_000))},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{RequireActiveVersion: ptr.Ref(false)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DeprecationMessage: ptr.Ref("now deprecated")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DeprecationMessage: ptr.Ref("")},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{UseClassicParameterFlow: ptr.Ref(false)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DisableModuleCache: ptr.Ref(false)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		// CORS behavior.
		{
			...
			req: nicloudsdk.UpdateTemplateMeta{
				CORSBehavior: ptr.Ref(nicloudsdk.CORSBehavior(database.CorsBehaviorSimple)),
			},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req: nicloudsdk.UpdateTemplateMeta{
				CORSBehavior: ptr.Ref(nicloudsdk.CORSBehavior("")),
			},
		...
		},
		{
			...
			req: nicloudsdk.UpdateTemplateMeta{
				CORSBehavior: ptr.Ref(nicloudsdk.CORSBehavior("not-a-real-value")),
			},
			expected: expected{
		...
		// the corresponding *Intent field being false; only true triggers it.
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DisableEveryoneGroupAccess: ptr.Ref(false)},
			expected: expected{override: func(*templateMetaUpdate) {
		...
		},
		{
			...
			req:  nicloudsdk.UpdateTemplateMeta{DisableEveryoneGroupAccess: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:      nicloudsdk.UpdateTemplateMeta{UpdateWorkspaceLastUsedAt: ptr.Ref(false)},
			expected: expected{override: func(*templateMetaUpdate) {}},
		},
		{
			name: "UpdateWorkspaceLastUsedAtTrue",
			req:  nicloudsdk.UpdateTemplateMeta{UpdateWorkspaceLastUsedAt: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
		...
		},
		{
			...
			req:      nicloudsdk.UpdateTemplateMeta{UpdateWorkspaceDormantAt: ptr.Ref(false)},
			expected: expected{override: func(*templateMetaUpdate) {}},
		},
		{
			name: "UpdateWorkspaceDormantAtTrue",
			req:  nicloudsdk.UpdateTemplateMeta{UpdateWorkspaceDormantAt: ptr.Ref(true)},
			expected: expected{override: func(r *templateMetaUpdate) {
...
func TestResolveTemplateMetaUpdate_NameClearedFallsBackToTemplateName(t *testing.T) {
	...
	got, _ := resolveTemplateMetaUpdate(tpl, schedOpts, nicloudsdk.UpdateTemplateMeta{
		Name: ptr.Ref(""),
	})
...
func TestResolveTemplateMetaUpdate_NilRequestUsesScheduleOptsForRequirements(t *testing.T) {
	...
	got, validErrs := resolveTemplateMetaUpdate(tpl, schedOpts, nicloudsdk.UpdateTemplateMeta{})
	if len(validErrs) != 0 {
