...
type Dispatcher interface {
	...
	Dispatch(ctx context.Context, userID uuid.UUID, notification nicloudsdk.WebpushMessage) error
	// Test sends a test web push notificatoin to a subscription to ensure it is valid.
	Test(ctx context.Context, req nicloudsdk.WebpushSubscription) error
...
func (n *Webpusher) Dispatch(ctx context.Context, userID uuid.UUID, msg nicloudsdk.WebpushMessage) error {
...
func (n *Webpusher) Test(ctx context.Context, req nicloudsdk.WebpushSubscription) error {
	msgJSON, err := json.Marshal(nicloudsdk.WebpushMessage{
		Title: "It's working!",
...
func (n *NoopWebpusher) Dispatch(context.Context, uuid.UUID, nicloudsdk.WebpushMessage) error {
	return xerrors.New(n.Msg)
}

func (n *NoopWebpusher) Test(context.Context, nicloudsdk.WebpushSubscription) error {
	return xerrors.New(n.Msg)
}
