...
// @Param request body nicloudsdk.CreateUserSkillRequest true "Create user skill request"
// @Success 201 {object} nicloudsdk.UserSkill
...
func (api *API) postUserSkill(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.CreateUserSkillRequest
...
// @Tags Users
// @Param user path string true "User ID, username, or me"
// @Success 200 {array} nicloudsdk.UserSkillMetadata
...
// @Success 200 {object} nicloudsdk.UserSkill
...
// @Param user path string true "User ID, username, or me"
// @Param skillName path string true "Skill name"
// @Param request body nicloudsdk.UpdateUserSkillRequest true "Update user skill request"
// @Success 200 {object} nicloudsdk.UserSkill
...
func (api *API) patchUserSkill(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.UpdateUserSkillRequest
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
