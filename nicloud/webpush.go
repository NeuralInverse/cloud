...
// @Accept json
// @Tags Notifications
// @Param request body nicloudsdk.WebpushSubscription true "Webpush subscription"
...
func (api *API) postUserWebpushSubscription(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.WebpushSubscription
...
// @Accept json
// @Tags Notifications
// @Param request body nicloudsdk.DeleteWebpushSubscription true "Webpush subscription"
// @Param user path string true "User ID, name, or me"
...
func (api *API) deleteUserWebpushSubscription(rw http.ResponseWriter, r *http.Request) {
	...
	var req nicloudsdk.DeleteWebpushSubscription
	if !httpapi.Read(ctx, rw, r, &req) {
		return
	}
...
func (api *API) postUserPushNotificationTest(rw http.ResponseWriter, r *http.Request) {
	...
	if err := api.WebpushDispatcher.Dispatch(ctx, user.ID, nicloudsdk.WebpushMessage{
		Title: "It's working!",
