...
// @Produce json
// @Tags Applications
// @Success 200 {object} nicloudsdk.AppHostResponse
// @Router /api/v2/applications/host [get]
// @Deprecated use api/v2/regions and see the primary proxy.
func (api *API) appHost(rw http.ResponseWriter, r *http.Request) {
	httpapi.Write(r.Context(), rw, http.StatusOK, nicloudsdk.AppHostResponse{
...
func (api *API) workspaceApplicationAuth(rw http.ResponseWriter, r *http.Request) {
	...
	cookie, _, err := api.createAPIKey(ctx, apikey.CreateParams{
		...
		Scope:           database.ApiKeyScopeNIApplicationConnect,
	})
	if err != nil {
		httpapi.Write(ctx, rw, http.StatusInternalServerError, nicloudsdk.Response{
