...
func TestDialFailure(t *testing.T) {
	...
	dialer := &nicloud.InmemTailnetDialer{
		CoordPtr:            &coordPtr,
		Logger:              logger,
...
func setupServerTailnetAgent(t *testing.T, agentNum int, opts ...tailnettest.DERPAndStunOption) ([]agentWithID, *nicloud.ServerTailnet) {
	logger := testutil.Logger(t)
	...
	serverTailnet, err := nicloud.NewServerTailnet(
		context.Background(),
		logger,
		derpServer,
		dialer,
