...
func TestAzureAKPKIWithCoderd(t *testing.T) {
	...
	cfg := fake.OIDCConfig(t, scopes, func(cfg *nicloud.OIDCConfig) {
	...
	owner, _, api := nicloudtest.NewWithAPI(t, &nicloudtest.Options{
		OIDCConfig: cfg,
	})

	// Create a user and login
	const email = "alice@cloud.neuralinverse.com"
