...
func TestOAuth2ClientMetadataValidation(t *testing.T) {
	...
	t.Run("GrantTypeValidation", func(t *testing.T) {
		...
		tests := []struct {
			name        string
			grantTypes  []nicloudsdk.OAuth2ProviderGrantType
			expectError bool
		}{
			{
				name:        "DefaultEmpty",
			...
			},
			{
				...
				grantTypes:  []nicloudsdk.OAuth2ProviderGrantType{nicloudsdk.OAuth2ProviderGrantTypeAuthorizationCode},
				expectError: false,
			},
			{
				name:        "InvalidRefreshTokenAlone",
				grantTypes:  []nicloudsdk.OAuth2ProviderGrantType{nicloudsdk.OAuth2ProviderGrantTypeRefreshToken},
			...
			},
			{
				...
				grantTypes:  []nicloudsdk.OAuth2ProviderGrantType{nicloudsdk.OAuth2ProviderGrantTypeClientCredentials},
				expectError: true,
			},
			{
				name:        "InvalidPassword",
				grantTypes:  []nicloudsdk.OAuth2ProviderGrantType{nicloudsdk.OAuth2ProviderGrantTypePassword},
				expectError: true,
			},
			{
				name:        "InvalidImplicit",
				grantTypes:  []nicloudsdk.OAuth2ProviderGrantType{nicloudsdk.OAuth2ProviderGrantTypeImplicit},
				expectError: true,
			},
			{
				name:        "MixedValidInvalid",
				grantTypes:  []nicloudsdk.OAuth2ProviderGrantType{nicloudsdk.OAuth2ProviderGrantTypeAuthorizationCode, nicloudsdk.OAuth2ProviderGrantTypeClientCredentials},
				expectError: true,
			},
		}
	...
	t.Run("ResponseTypeValidation", func(t *testing.T) {
		...
		tests := []struct {
			name          string
			responseTypes []nicloudsdk.OAuth2ProviderResponseType
			expectError   bool
		}{
			{
				name:          "DefaultEmpty",
			...
			{
				name:          "InvalidToken",
				responseTypes: []nicloudsdk.OAuth2ProviderResponseType{nicloudsdk.OAuth2ProviderResponseTypeToken},
				expectError:   true,
			},
			{
				name:          "InvalidIDToken",
				responseTypes: []nicloudsdk.OAuth2ProviderResponseType{"id_token"}, // OIDC-specific, no constant
				expectError:   true,
			},
			{
				name:          "InvalidMultiple",
				responseTypes: []nicloudsdk.OAuth2ProviderResponseType{nicloudsdk.OAuth2ProviderResponseTypeCode, nicloudsdk.OAuth2ProviderResponseTypeToken},
				expectError:   true,
			},
		}
	...
	t.Run("TokenEndpointAuthMethodValidation", func(t *testing.T) {
		...
		tests := []struct {
			name        string
			authMethod  nicloudsdk.OAuth2TokenEndpointAuthMethod
			expectError bool
		}{
			{
				name:        "DefaultEmpty",
			...
			},
			{
				...
				authMethod:  nicloudsdk.OAuth2TokenEndpointAuthMethodClientSecretBasic,
				expectError: false,
			},
			{
				name:        "ValidClientSecretPost",
				authMethod:  nicloudsdk.OAuth2TokenEndpointAuthMethodClientSecretPost,
				expectError: false,
			},
			{
				name:        "ValidNone",
				authMethod:  nicloudsdk.OAuth2TokenEndpointAuthMethodNone,
...
func TestOAuth2ClientMetadataDefaults(t *testing.T) {
	...
	require.Contains(t, config.GrantTypes, nicloudsdk.OAuth2ProviderGrantTypeAuthorizationCode)

	// Should default to code
	require.Contains(t, config.ResponseTypes, nicloudsdk.OAuth2ProviderResponseTypeCode)

	// Should default to client_secret_basic or client_secret_post
	require.True(t, config.TokenEndpointAuthMethod == nicloudsdk.OAuth2TokenEndpointAuthMethodClientSecretBasic ||
		config.TokenEndpointAuthMethod == nicloudsdk.OAuth2TokenEndpointAuthMethodClientSecretPost ||
