...
func CreateTestOAuth2App(t *testing.T, client *nicloudsdk.Client) (*nicloudsdk.OAuth2ProviderApp, string) {
	t.Helper()
...
func doAuthorizeRequest(t *testing.T, client *nicloudsdk.Client, baseURL string, params AuthorizeParams) *http.Response {
	t.Helper()
	...
	// Add session token
	req.Header.Set("NI-Session-Token", client.SessionToken())
...
func AuthorizeOAuth2App(t *testing.T, client *nicloudsdk.Client, baseURL string, params AuthorizeParams) string {
	t.Helper()
...
func CleanupOAuth2App(t *testing.T, client *nicloudsdk.Client, appID uuid.UUID) {
	t.Helper()
...
func AuthorizeOAuth2AppExpectingError(t *testing.T, client *nicloudsdk.Client, baseURL string, params AuthorizeParams, expectedStatusCode int) {
	t.Helper()
