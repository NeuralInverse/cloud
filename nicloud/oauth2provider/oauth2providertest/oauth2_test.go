...
import (
	...
	"github.com/NeuralInverse/cloud/v2/nicloud/oauth2provider/oauth2providertest"
...
func TestOAuth2PKCEPlainMethodRejected(t *testing.T) {
	...
	authParams := oauth2providertest.AuthorizeParams{
		ClientID:            app.ID.String(),
		ResponseType:        string(nicloudsdk.OAuth2ProviderResponseTypeCode),
		RedirectURI:         oauth2providertest.TestRedirectURI,
		State:               state,
		CodeChallenge:       codeChallenge,
		CodeChallengeMethod: string(nicloudsdk.OAuth2PKCECodeChallengeMethodPlain),
	}
