...
func TestCollectInsights(t *testing.T) {
	...
	ownerClient := nicloudtest.New(t, options)
	...
	ok := assert.Eventuallyf(t, func() bool {
		...
		for _, metric := range metrics {
			...
			case "nicloud_insights_applications_usage_seconds", "nicloud_insights_templates_active_users", "nicloud_insights_parameters":
