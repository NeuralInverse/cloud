...
func TestGitlabDefaults(t *testing.T) {
	...
	// values.
	cloud := func() nicloudsdk.ExternalAuthConfig {
		return nicloudsdk.ExternalAuthConfig{
			Type:                          string(nicloudsdk.EnhancedExternalAuthProviderGitLab),
			ID:                            string(nicloudsdk.EnhancedExternalAuthProviderGitLab),
	...
	tests := []struct {
		...
		mutateExpected func(*nicloudsdk.ExternalAuthConfig)
	}{
		// Cloud
		{
			name: "OnlyType",
		...
		},
		{
			...
			expected: cloud(),
			mutateExpected: func(config *nicloudsdk.ExternalAuthConfig) {
...
func Test_bitbucketServerConfigDefaults(t *testing.T) {
	...
	bbType := string(nicloudsdk.EnhancedExternalAuthProviderBitBucketServer)
	tests := []struct {
		name     string
		config   *nicloudsdk.ExternalAuthConfig
		expected nicloudsdk.ExternalAuthConfig
	}{
		{
		...
		},
		{
			...
			expected: nicloudsdk.ExternalAuthConfig{
				Type:                          string(nicloudsdk.EnhancedExternalAuthProviderBitBucketCloud),
