...
func mcpDeploymentValues(t testing.TB) *nicloudsdk.DeploymentValues {
	t.Helper()

	return nicloudtest.DeploymentValues(t)
}

// newMCPClient creates a test server and returns the admin client.
func newMCPClient(t testing.TB) *nicloudsdk.Client {
	t.Helper()

	providerKeys := nicloudtest.FakeOpenAICompatProviderAPIKeys(t)
	return nicloudtest.New(t, &nicloudtest.Options{
...
func createMCPServerConfig(t testing.TB, client *nicloudsdk.Client, slug string, enabled bool) nicloudsdk.MCPServerConfig {
	t.Helper()

	ctx := testutil.Context(t, testutil.WaitLong)
	config, err := client.CreateMCPServerConfig(ctx, nicloudsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsCRUD(t *testing.T) {
	...
	created, err := client.CreateMCPServerConfig(ctx, nicloudsdk.CreateMCPServerConfigRequest{
	...
	require.False(t, created.ForwardNIHeaders)
	...
	forwardNIHeaders := true
	updated, err := client.UpdateMCPServerConfig(ctx, created.ID, nicloudsdk.UpdateMCPServerConfigRequest{
		DisplayName:         &newName,
		Availability:        &newAvail,
		AllowInPlanMode:     &allowInPlanMode,
		ForwardNIHeaders: &forwardNIHeaders,
	})
	require.NoError(t, err)
	...
	require.True(t, updated.ForwardNIHeaders)
	...
	require.True(t, configs[0].ForwardNIHeaders)

	fetched, err = client.MCPServerConfigByID(ctx, created.ID)
	require.NoError(t, err)
	require.True(t, fetched.AllowInPlanMode)
	require.True(t, fetched.ForwardNIHeaders)
...
func TestMCPServerConfigsSecretsNeverLeaked(t *testing.T) {
	...
	created, err := adminClient.CreateMCPServerConfig(ctx, nicloudsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsAuthConnected(t *testing.T) {
	...
	_, err = adminClient.CreateMCPServerConfig(ctx, nicloudsdk.CreateMCPServerConfigRequest{
...
func TestMCPServerConfigsAvailability(t *testing.T) {
	...
	t.Run("InvalidAvailability", func(t *testing.T) {
		t.Parallel()
		ctx := testutil.Context(t, testutil.WaitLong)
		_, err := client.CreateMCPServerConfig(ctx, nicloudsdk.CreateMCPServerConfigRequest{
...
func createChatModelConfigForMCP(t testing.TB, client *nicloudsdk.ExperimentalClient) nicloudsdk.ChatModelConfig {
	t.Helper()
