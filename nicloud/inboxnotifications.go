...
import (
	...
	markdown "github.com/NeuralInverse/cloud/v2/nicloud/render"
...
var fallbackIcons = map[uuid.UUID]string{
	...
	notifications.TemplateWorkspaceCreated:           nicloudsdk.InboxNotificationFallbackIconWorkspace,
	notifications.TemplateWorkspaceManuallyUpdated:   nicloudsdk.InboxNotificationFallbackIconWorkspace,
	notifications.TemplateWorkspaceDeleted:           nicloudsdk.InboxNotificationFallbackIconWorkspace,
	notifications.TemplateWorkspaceAutobuildFailed:   nicloudsdk.InboxNotificationFallbackIconWorkspace,
	notifications.TemplateWorkspaceDormant:           nicloudsdk.InboxNotificationFallbackIconWorkspace,
	notifications.TemplateWorkspaceAutoUpdated:       nicloudsdk.InboxNotificationFallbackIconWorkspace,
	notifications.TemplateWorkspaceMarkedForDeletion: nicloudsdk.InboxNotificationFallbackIconWorkspace,
	...
	notifications.TemplateUserAccountDeleted:           nicloudsdk.InboxNotificationFallbackIconAccount,
	notifications.TemplateUserAccountSuspended:         nicloudsdk.InboxNotificationFallbackIconAccount,
	notifications.TemplateUserAccountActivated:         nicloudsdk.InboxNotificationFallbackIconAccount,
	notifications.TemplateYourAccountSuspended:         nicloudsdk.InboxNotificationFallbackIconAccount,
	notifications.TemplateYourAccountActivated:         nicloudsdk.InboxNotificationFallbackIconAccount,
	notifications.TemplateUserRequestedOneTimePasscode: nicloudsdk.InboxNotificationFallbackIconAccount,

	// template related notifications
	notifications.TemplateTemplateDeleted:             nicloudsdk.InboxNotificationFallbackIconTemplate,
	notifications.TemplateTemplateDeprecated:          nicloudsdk.InboxNotificationFallbackIconTemplate,
	notifications.TemplateWorkspaceBuildsFailedReport: nicloudsdk.InboxNotificationFallbackIconTemplate,

	// chat related notifications
	notifications.TemplateChatAutoArchiveDigest: nicloudsdk.InboxNotificationFallbackIconOther,
}

func ensureNotificationIcon(notif nicloudsdk.InboxNotification) nicloudsdk.InboxNotification {
	if notif.Icon != "" {
		return notif
	}
	...
	if !ok {
		fallbackIcon = nicloudsdk.InboxNotificationFallbackIconOther
	}
...
// convertInboxNotificationResponse works as a util function to transform a database.InboxNotification to nicloudsdk.InboxNotification
func convertInboxNotificationResponse(ctx context.Context, logger slog.Logger, notif database.InboxNotification) nicloudsdk.InboxNotification {
	convertedNotif := nicloudsdk.InboxNotification{
		ID:         notif.ID,
		UserID:     notif.UserID,
		...
		Icon:       notif.Icon,
		Actions: func() []nicloudsdk.InboxNotificationAction {
			var actionsList []nicloudsdk.InboxNotificationAction
...
// @Success 200 {object} nicloudsdk.GetInboxNotificationResponse
...
func (api *API) watchInboxNotifications(rw http.ResponseWriter, r *http.Request) {
	...
	notificationCh := make(chan nicloudsdk.InboxNotification, 10)
	...
	for {
		...
		case notif := <-notificationCh:
			...
			if err := encoder.Encode(nicloudsdk.GetInboxNotificationResponse{
				Notification: notif,
...
// @Success 200 {object} nicloudsdk.ListInboxNotificationsResponse
...
func (api *API) listInboxNotifications(rw http.ResponseWriter, r *http.Request) {
	...
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.ListInboxNotificationsResponse{
		Notifications: func() []nicloudsdk.InboxNotification {
			notificationsList := make([]nicloudsdk.InboxNotification, 0, len(notifs))
...
func (api *API) updateInboxNotificationReadStatus(rw http.ResponseWriter, r *http.Request) {
	...
	var body nicloudsdk.UpdateInboxNotificationReadStatusRequest
	...
	httpapi.Write(ctx, rw, http.StatusOK, nicloudsdk.UpdateInboxNotificationReadStatusResponse{
