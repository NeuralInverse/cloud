...
func requestWithRetries(ctx context.Context, t require.TestingT, client *nicloudsdk.Client, method, path string, body interface{}, opts ...nicloudsdk.RequestOption) (*http.Response, error) {
