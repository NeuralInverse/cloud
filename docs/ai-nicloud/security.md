...
> require the [AI Governance Add-On](./ai-governance.md). As of Neural Inverse Cloud v2.32,
> deployments without the add-on will not be able to access these features.

As the AI landscape is evolving, we are working to ensure Neural Inverse Cloud remains a secure
...
which models you are comfortable with and configure your Neural Inverse Cloud templates to use
those.

## Set up Firewalls and Proxies

Many enterprises run Neural Inverse Cloud workspaces behind a firewall or a proxy to prevent
...
Additional guidance and tooling is coming in future releases of Neural Inverse Cloud.

## Set Up Agent Firewall

Agent Firewall is a process-level firewall that lets you restrict and
audit what AI agents can access within Neural Inverse Cloud workspaces. To learn more about
