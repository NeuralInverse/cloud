...
1. Paste the following JSON configuration, replacing `<your-coder-api-token>` with your **[Neural Inverse Cloud API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**:
