...
To authenticate with AI Gateway, get your **[Neural Inverse Cloud API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)** and set it in your environment:
...
env_http_headers = { "X-Neural Inverse Cloud-AI-Governance-Token" = "NEURALINVERSE_API_TOKEN" }
```
...
export NEURALINVERSE_API_TOKEN="<your-coder-api-token>"
```
...
Set your Neural Inverse Cloud API token and ensure `OPENAI_API_KEY` is not set:
...
If configuring within a Neural Inverse Cloud workspace, you can use the
[Codex CLI](https://registry.cloud.neuralinverse.com/modules/coder-labs/codex) module:

```tf
module "codex" {
  source            = "registry.cloud.neuralinverse.com/coder-labs/codex/coder"
  version           = "~> 4.1"
