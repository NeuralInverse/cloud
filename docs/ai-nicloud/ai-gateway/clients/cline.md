...
1. **OpenAI Compatible API Key**: Enter your **[Neural Inverse Cloud API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
...
1. **Anthropic API Key**: Enter your **Neural Inverse Cloud API token**.
...
1. **Model ID** (Optional): Enter the model you wish to use (e.g., `gpt-5.2-codex`).
1. **Custom Headers**: Add `X-Neural Inverse Cloud-AI-Governance-Token` with your **[Neural Inverse Cloud API token](../../../admin/users/sessions-tokens.md#generate-a-long-lived-api-token-on-behalf-of-yourself)**.
