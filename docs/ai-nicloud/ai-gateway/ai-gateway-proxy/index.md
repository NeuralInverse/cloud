...
Clients authenticate by passing their Neural Inverse Cloud token in the proxy credentials.
...
* [Set up AI Gateway Proxy](./setup.md) on your Neural Inverse Cloud deployment
