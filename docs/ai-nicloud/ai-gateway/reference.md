...
`nicloud` runs an in-memory instance of `aibridged`, whose logic is mostly contained in https://github.com/NeuralInverse/cloud/tree/main/aibridge. In future releases we will support running external instances for higher throughput and complete memory isolation from `nicloud`.
...
To report a bug, file a feature request, or view a list of known issues, please visit our [GitHub repository](https://github.com/NeuralInverse/cloud/issues). If you encounter issues with AI Gateway, please reach out to us via [Discord](https://discord.gg/coder).
