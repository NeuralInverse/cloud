...
|-------------|---------------------------------------------------------------|
| Type        | <code>string</code>                                           |
| Environment | <code>$NEURALINVERSE_EXTERNAL_TOKEN_ENCRYPTION_ENCRYPT_NEW_KEY</code> |
...
| Environment | <code>$NEURALINVERSE_EXTERNAL_TOKEN_ENCRYPTION_ENCRYPT_OLD_KEYS</code> |
