...
|--------|---------------------------------------------------------|-------------|--------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | [nicloudsdk.WorkspaceBuild](schemas.md#nicloudsdkworkspacebuild) |
...
| Status | Meaning                                                 | Description | Schema                                                                                  |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [nicloudsdk.WorkspaceBuildParameter](schemas.md#nicloudsdkworkspacebuildparameter) |
...
| `body`           | body | [nicloudsdk.UpdateWorkspaceBuildStateRequest](schemas.md#nicloudsdkupdateworkspacebuildstaterequest) | true     | Request body       |
...
| Status | Meaning                                                 | Description | Schema                                                                |
|--------|---------------------------------------------------------|-------------|-----------------------------------------------------------------------|
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1) | OK          | array of [nicloudsdk.WorkspaceBuild](schemas.md#nicloudsdkworkspacebuild) |
...
| `» reason`                       | [nicloudsdk.BuildReason](schemas.md#nicloudsdkbuildreason)                                                 | false    |              |                                                                                                                                                                                                                                                |
...
| `»» type`                        | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `»» workspace_transition`        | [nicloudsdk.WorkspaceTransition](schemas.md#nicloudsdkworkspacetransition)                                 | false    |              |                                                                                                                                                                                                                                                |
| `» status`                       | [nicloudsdk.WorkspaceStatus](schemas.md#nicloudsdkworkspacestatus)                                         | false    |              |                                                                                                                                                                                                                                                |
| `» template_version_id`          | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `» template_version_name`        | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
| `» template_version_preset_id`   | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `» transition`                   | [nicloudsdk.WorkspaceTransition](schemas.md#nicloudsdkworkspacetransition)                                 | false    |              |                                                                                                                                                                                                                                                |
| `» updated_at`                   | string(date-time)                                                                                      | false    |              |                                                                                                                                                                                                                                                |
| `» workspace_id`                 | string(uuid)                                                                                           | false    |              |                                                                                                                                                                                                                                                |
| `» workspace_name`               | string                                                                                                 | false    |              |                                                                                                                                                                                                                                                |
...
|-------------|------|----------------------------------------------------------------------------------------|----------|--------------------------------|
| `workspace` | path | string(uuid)                                                                           | true     | Workspace ID                   |
| `body`      | body | [nicloudsdk.CreateWorkspaceBuildRequest](schemas.md#nicloudsdkcreateworkspacebuildrequest) | true     | Create workspace build request |
