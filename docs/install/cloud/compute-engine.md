...
In this guide, you will learn how to deploy the Neural Inverse Cloud control plane instance and
your first template.
...
## Launch a Neural Inverse Cloud instance from the Google Cloud Marketplace

We publish an Ubuntu 22.04 VM image with Neural Inverse Cloud and Docker pre-installed.
...
![Neural Inverse Cloud on GCP Marketplace](../../images/platforms/gcp/marketplace.png)
...
<video autoplay playsinline loop>
  <source src="https://github.com/NeuralInverse/cloud/blob/main/docs/images/platforms/gcp/launch.mp4?raw=true" type="video/mp4">
Your browser does not support the video tag.
</video>

Be sure to add a keypair so that you can connect over SSH to further
[configure Neural Inverse Cloud](../../admin/setup/index.md).
...
![Neural Inverse Cloud on GCP Marketplace start](../../images/platforms/gcp/start.png)
...
![Neural Inverse Cloud Workspace and IDE in GCP VM](../../images/platforms/aws/workspace.png)

## Configuring Neural Inverse Cloud server

Neural Inverse Cloud is primarily configured by server-side flags and environment variables.
Given you created or added key-pairs when launching the instance, you can
[configure your Neural Inverse Cloud deployment](../../admin/setup/index.md) by logging in via
...
sudo systemctl restart coder # restart Neural Inverse Cloud
```

## Give developers VM workspaces (optional)

Instead of running containers on the Neural Inverse Cloud instance, you can offer developers
full VM instances with the
[gcp-linux](https://github.com/NeuralInverse/cloud/tree/main/examples/templates/gcp-linux)
template.

Before you can use this template, you must authorize Neural Inverse Cloud to create VM
instances in your GCP project. Follow the instructions in the
[gcp-linux template README](https://github.com/NeuralInverse/cloud/tree/main/examples/templates/gcp-linux#authentication)
to set up authentication.

### Next Steps

- [Use your IDE with Neural Inverse Cloud](../../user-guides/workspace-access/index.md)
