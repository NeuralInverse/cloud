...
| Built-in proxy           | Includes development proxy (not needed with Neural Inverse Cloud)                          | No built-in development proxy                                     |
...
| Proxy integration        | Integrates with Neural Inverse Cloud's proxy for ports panel                               | Integration is more limited                                       |
...
For more information about code-server, visit the [code-server FAQ](https://cloud.neuralinverse.com/docs/code-server/FAQ).
