...
func generate() ([]byte, error) {
	...
	if _, err := b.WriteString("package nicloudsdk\n\n"); err != nil {
		return nil, err
	}
	...
	// We generate everything into nicloudsdk/apikey_scopes_gen.go as the
	...
	if _, err := b.WriteString("\t// Deprecated: use nicloudsdk.APIKeyScopeNeural Inverse CloudAll instead.\n"); err != nil {
		return nil, err
	}
	if _, err := b.WriteString("\tAPIKeyScopeAll APIKeyScope = \"all\"\n"); err != nil {
		return nil, err
	}
	if _, err := b.WriteString("\t// Deprecated: use nicloudsdk.APIKeyScopeNeural Inverse CloudApplicationConnect instead.\n"); err != nil {
		return nil, err
	}
